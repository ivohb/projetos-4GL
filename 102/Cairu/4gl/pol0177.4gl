# SISTEMA.: COMERCIAL                                               #
# PROGRAMA: pol0177                                                 #
# MODULOS.: pol0177 - LOG0010 - LOG0030 - LOG0040 - LOG0050         #
...
MAIN
  ...
  DEFER INTERRUPT
  LET p_versao="POL0177-10.02.01"
  INITIALIZE p_nom_help TO NULL
  CALL log140_procura_caminho("pol0177.iem") RETURNING p_nom_help
  ...
  IF p_status = 0  THEN
     CALL pol0177_controle()
  END IF
END MAIN

#--------------------------#
 FUNCTION pol0177_controle()
#--------------------------#
 CALL log006_exibe_teclas("01",p_versao)
 INITIALIZE p_nom_tela TO NULL
 CALL log130_procura_caminho("pol0177") RETURNING p_nom_tela
 LET  p_nom_tela = p_nom_tela CLIPPED
 OPEN WINDOW w_pol0177 AT 2,2 WITH FORM p_nom_tela
 ...
 MENU "OPCAO"
   ...
   COMMAND KEY ("!")
    ...
    COMMAND KEY ("O") "sObre" "Exibe a versão do programa"
      ...
      EXIT MENU
 END MENU
 CLOSE WINDOW w_pol0177
 END FUNCTION

#-----------------------#
FUNCTION pol0177_sobre()
#-----------------------#
...
IF log028_saida_relat(17,35) IS NOT NULL THEN
   ...
   IF p_ies_impressao = "S" THEN 
      IF g_ies_ambiente = "U"  THEN
         START REPORT pol0177_relat TO PIPE p_nom_arquivo
      ELSE
         CALL log150_procura_caminho ('LST') RETURNING p_caminho
         LET p_caminho = p_caminho CLIPPED, 'pol0177.tmp'
         START REPORT pol0177_relat TO p_caminho 
      END IF
   ELSE
      START REPORT pol0177_relat TO p_nom_arquivo
   END IF
END IF 
...
FOREACH cq_consulta INTO p_nf_mestre.*                                
  ...
  OUTPUT TO REPORT pol0177_relat(p_relat.*) 

END FOREACH

FINISH REPORT pol0177_relat  
