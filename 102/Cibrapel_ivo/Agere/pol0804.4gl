...
GLOBALS
  ...
  DEFINE pr_item             ARRAY[999999999] OF RECORD
         tipo_empresa         CHAR(02), #LIKE reserva_erro_885.tipo_empresa,
         ...
         num_rsv_relac        INTEGER #LIKE reserva_erro_885.num_rsv_relac 
   END RECORD
...
#---------------------------------#
   ...
   LET p_index = 1
      ...
      LET sql_stmt = 
          "SELECT tipo_empresa,num_reserva,cod_item,des_erro,num_rsv_relac ",
          "  FROM reserva_erro_885",
...
#----------------------#
   ...
   FORMAT
      ...
      PAGE HEADER  
         ...
         PRINT COLUMN 001, "--------------------------------------------------------------------------------------------------------------"
         PRINT
         PRINT COLUMN 001, 'Tip. Empre  Num.Reser.     Item                     Desc. Erro                             Num. Reserv Relac  '   
         PRINT COLUMN 001, '----------  ---------- --------------- --------------------------------------------------  -------------------'
         PRINT               
         
      ON EVERY ROW

         PRINT COLUMN 005, pr_item[p_index].tipo_empresa, 
               COLUMN 012, pr_item[p_index].num_reserva, 
               COLUMN 024, pr_item[p_index].cod_item,
               COLUMN 040, pr_item[p_index].des_erro, 
               COLUMN 092, pr_item[p_index].num_rsv_relac
