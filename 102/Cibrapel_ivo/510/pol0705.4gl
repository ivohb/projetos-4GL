...
GLOBALS
   DEFINE p_cod_turno          LIKE turno.cod_turno,
          ...
          p_cod_turnos         LIKE de_para_turno_885.turno_simula,
          p_data_disp          LIKE de_para_turno_885.turno_logix,
          p_retorno            SMALLINT,
   ...
   DEFINE p_de_para_turno_885  RECORD LIKE de_para_turno_885.*,
          p_de_para_turno_885a  RECORD LIKE de_para_turno_885.* 
...
#---------------------------------------#
   ...
   INPUT BY NAME p_de_para_turno_885.* 
      ...
      IF STATUS = 0 THEN
         ERROR "Código do Turno Trim já Cadastrado na Tabela de_para_turno_885!!!"
         NEXT FIELD turno_simula
      END IF
...
#-------------------------------#
    ...
    DEFINE pr_empresa       ARRAY[3000]
     OF RECORD
         turno_logix       LIKE de_para_turno_885.turno_logix,
