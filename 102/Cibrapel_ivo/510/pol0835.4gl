 ...
 OUTPUT LEFT   MARGIN   1 
   ...
   FORMAT
      ...
      PRINT  COLUMN 001, p_relat.num_nf USING '######',
             COLUMN 008, p_relat.dat_emis_nf,
             COLUMN 020, p_relat.nom_fornecedor[1,40],
             COLUMN 062, p_relat.val_tot_nf_c USING '####,###,##&.&&'
