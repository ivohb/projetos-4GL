...
MAIN
  ...
  IF p_status = 0 THEN 
    CALL pol1089_controle()
  END IF
END MAIN

#----------------------------#
 FUNCTION pol1089_controle()
#----------------------------#
  CALL log006_exibe_teclas("01", p_versao)

  CALL log130_procura_caminho("pol1089") RETURNING p_nom_tela 
  OPEN WINDOW w_pol1089 AT 7,11 WITH FORM p_nom_tela
  ...
  MENU "OPCAO"
    COMMAND "Processar" "Atualiza pedidos, inclui num_pedido_cli no pedido"
      HELP 0116
      MESSAGE ""
     IF pol1089_processa_atualizacao() THEN 
    ...
    COMMAND "Fim"        "Retorna ao Menu Anterior"
      ...
      EXIT MENU
  END MENU
  CLOSE WINDOW w_pol1089
END FUNCTION

#-------------------------------------#
FUNCTION pol1089_processa_atualizacao()
#-------------------------------------#
