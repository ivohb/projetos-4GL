...
MAIN
   ...
   IF p_status = 0 THEN
      CALL pol1186_proces_apto(p_user, p_cod_empresa,"") RETURNING m_qtd_critica
   END IF
...
#------------------------------------------#
FUNCTION pol1186_proces_apto(l_u, l_e, l_p)#
#------------------------------------------#
   ...
   LET p_versao = "pol1186-12.00.05  "
   CALL func002_versao_prg(p_versao)

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE m_nom_tela TO NULL
   CALL log130_procura_caminho("pol1186") RETURNING m_nom_tela
   LET  m_nom_tela = m_nom_tela CLIPPED 
   OPEN WINDOW w_pol1186 AT 10,20 WITH FORM m_nom_tela 
   ...
   CALL pol1186_ins_proc(m_dat_atu)

   IF NOT pol1186_inicia_proc() THEN
   ...
   IF NOT m_houve_erro THEN
      IF NOT pol1186_atu_proces('N') THEN
         LET m_houve_erro = TRUE
      END IF
   END IF
   
   CLOSE WINDOW w_pol1186
   
   RETURN m_qtd_critica
   
END FUNCTION   

#-----------------------------#
FUNCTION pol1186_inicia_proc()#
#_----------------------------#
   
   LET p_tem_critica = FALSE
   
   IF NOT pol1186_chec_proces() THEN
      RETURN FALSE
   END IF
   
   IF NOT pol1186_exec_proces() THEN
      RETURN FALSE
   END IF
...
#----------------------------------------#
FUNCTION pol1186_atu_proces(l_ies_proces)#
#----------------------------------------#
...
#--------------------------------#
FUNCTION pol1186_ins_proc(l_data)#
#--------------------------------#
...
#-----------------------------#
   ...
   FOREACH cq_programa INTO m_num_programa
      ...
      CALL log0030_mensagem(m_num_programa,'info')
      
      LET p_criticou = FALSE
      
      CALL log085_transacao("BEGIN")
      
      IF NOT pol1186_chek_programa() THEN
         CALL log085_transacao("ROLLBACK")
         RETURN FALSE
      END IF

      IF p_criticou THEN
         IF NOT pol1186_critica_man_nest() then
            RETURN FALSE
         END IF
      ...
      ELSE
         ...
         IF NOT pol1186_aponta_prog() THEN
            CALL log085_transacao("ROLLBACK")
            RETURN FALSE
         END IF  
...
#-----------------------------#
   ...
   LET p_criticou = TRUE
   LET m_qtd_critica = m_qtd_critica + 1
...
#---------------------------#
   ...
   FOR l_ind = 1 TO m_qtd_erro
      ...
      IF NOT pol1186_insere_erro() THEN
         RETURN FALSE
      END IF
...
#--------------------------------#
 FUNCTION pol1186_chek_programa()#
#--------------------------------#
...
#-------------------------------#
   ...
   IF not pol1186_le_fechamento() THEN
      RETURN FALSE
   END IF
   ...
   FOREACH cq_consiste INTO p_programa.*
      ...
      IF p_man.qtd_sucata > 0 THEN
         ...
         IF NOT pol1186_le_it_sucata() THEN
            return FALSE
         end IF
      END if
...
#-------------------------------#
FUNCTION pol1186_le_fechamento()#
#-------------------------------#
...
#-----------------------------#
   ...
   FOREACH cq_aponta INTO 
      ...
      IF NOT pol1186_cria_w_parada() THEN
         RETURN FALSE
      END IF
      
   	  CALL man8237_cria_tables_man8237()
      CALL pol1186_cria_w_alt_comp_wms()
      ...
      IF NOT pol1186_cria_w_compon() THEN
         RETURN FALSE
      END IF
      ...
      IF NOT pol1186_carrega_baixa() THEN 
         RETURN FALSE
      END IF      
...
#--------------------------------#
 FUNCTION pol1186_cria_w_parada()#
#--------------------------------#
...
#-------------------------------------#
FUNCTION pol1186_cria_w_alt_comp_wms()#
#-------------------------------------#
...
#-------------------------------#
FUNCTION pol1186_cria_w_compon()#
#-------------------------------#
...
#--------------------------------#
FUNCTION pol1186_atu_man(l_forca)#
#--------------------------------#
...
#-------------------------------#
FUNCTION pol1186_carrega_baixa()#																						
#-------------------------------#
