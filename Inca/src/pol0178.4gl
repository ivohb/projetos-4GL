...
FORMAT
    ...
    BEFORE GROUP OF p_relat.den_item1   
       ...
       PRINT COLUMN 001,"A385,80,1,1,2,1,N,",      '"','Lote ',m_lote CLIPPED,'"'
       PRINT COLUMN 001,"A77,80,0,2,5,4,N,",        '"',m_qtd_peca,'"'
       PRINT COLUMN 001,"A20,85,0,2,1,1,N,",       '"'," Qtd ",'"'
       PRINT COLUMN 001,"A245,90,0,2,1,1,N,",      '"'," pcs",'"'
       ...
       PRINT COLUMN 001,"A785,80,1,1,2,1,N,",      '"','Lote ',m_lote CLIPPED,'"'               
       PRINT COLUMN 001,"A465,78,0,2,5,4,N,",      '"',m_qtd_peca,'"'                    
       PRINT COLUMN 001,"A410,90,0,2,1,1,N,",      '"'," Qtd ",'"'                       
       PRINT COLUMN 001,"A632,90,0,2,1,1,N,",      '"'," pcs",'"'                         
       PRINT COLUMN 001,"B430,138,0,E30,3,3,80,B,",'"',p_relat.cod_item_barra CLIPPED,'"'
       PRINT COLUMN 001,"P" CLIPPED,p_relat.qtd_etiqueta CLIPPED
