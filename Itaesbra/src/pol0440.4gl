...
DEFINE m_qtd_int    INTEGER,
       m_difer      DECIMAL(12,7)
   ...
   FOREACH cq_omit INTO p_ordem_montag_item.*                                                                
      ...
      FOREACH cq_estrut_item INTO p_estrut_item_indus.*                                                      
         ...
         IF p_estrut_item_indus.ies_arredonda =  'S' THEN
            LET m_qtd_int = p_qtd_neces   
            LET m_difer = p_qtd_neces - m_qtd_int
            IF m_difer >= 0.5 THEN
               LET m_qtd_int = m_qtd_int + 1               
            END IF    
            LET p_qtd_neces = m_qtd_int     
         END IF
