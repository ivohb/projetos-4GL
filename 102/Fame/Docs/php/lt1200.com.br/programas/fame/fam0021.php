<?PHP
 ...
 //Manutenção:    Marcelo Gonçalves Peres
 //Data manutenção: 13/05/2009
 //Módulo:         Fame
 //Processo:       Cadastro de Faixas de Comissoes Geral
 //Versão:         1.0
 $versao=1;
 $prog="fame/fam0021";
 //-----------------------------------------------------------------------------
 ...
 if($nome_<>"")
 {
  ...
  printf("<tr> <FORM METHOD='POST' ACTION='fam0021.php'></tr>");
  ...
  if($fazer=='E')
  {
   $cons_faz="delete from  lt1200_faixas_comis_geral 
            where faixa='".$faixa_c."'
              ";
  ...
  if($fazer=='I')
  {
   $cons_faz="insert into  lt1200_faixas_comis_geral (
  ...
  if($fazer=='A')
  {
   $cons_faz="update  lt1200_faixas_comis_geral set
                         pct_ini='".$pct_ini."',
                         pct_fin='".$pct_fin."',
                         pct_sal='".$pct_sal."'
                     where faixa='".$faixa_c."' ";
  ...
  printf("<tr>
      <td width='750'  style=$n_style colspan='75'     align='center'>
       ...
       Faixas de Comissoes Geral</font></b>
      </td>
     </tr>
     <tr>
  ...
  printf("<FORM METHOD='POST' ACTION='fam0021.php'>");
  printf("</tr>
      <tr>
