...
DtCreation                 datetime default getdate() not null,      -- Data e hora da Gravação do registro
DtIntegration              datetime,                      -- Data e hora da Leitura do registro
ErrDescription             varchar(200),                  -- descrição do erro
WODetCode                  varchar(20),                   -- código da operação que deu origem ao movimento.
Shift                      smallint,                      -- Turno no qual foi realizada a movimentação
DtProduction               datetime,                      -- data da produção
OriginalQty                decimal(19,4),                 -- quantidade original
CompanyCode                varchar(20),                   -- código da empresa
TraceLotCode               varchar(41),                   -- lote para movimentação
Selected                   smallint        not null,      -- 0 
DtEv                       smalldatetime   default getdate() not null -- data da produção
...
ResourceCode                varchar(15),
DtEv                        smalldatetime,  --data da produção
Shift                       smallint,
DtTimeStamp                 datetime,       --data do lançamento
UserCode_Start              varchar(30),
WOCode                      varchar(41),    --numero da odem
WODetCode                   varchar(20),    -- código da operação
WOShiftProdT                int,            -- tempo produtivo
Integrated                  tinyint,        -- 0=Liberado 1=em processo 2=int c/ sucesso 3=int. com erro
DtCreation                  datetime,       -- data e hora da gravação do registro
DtIntegration               datetime,       -- data e hora da leitura do registro
