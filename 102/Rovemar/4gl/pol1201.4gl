...
MAIN
   ...
   DEFER INTERRUPT
   LET p_versao = "pol1201-10.02.01"
   INITIALIZE p_nom_help TO NULL  
   CALL log140_procura_caminho("pol1201.iem") RETURNING p_nom_help
   ...
   IF p_status = 0  THEN
      CALL pol1201_controle()
   END IF
END MAIN

#--------------------------#
 FUNCTION pol1201_controle()
#--------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol1201") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol1201 AT 2,2 WITH FORM p_nom_tela
   ...
   MENU "OPCAO"
      COMMAND "Incluir" "Inclui Dados na Tabela"
         ...
         CALL pol1201_modificar() RETURNING p_status
         IF p_status THEN
      ...
      COMMAND "Fim"       "Retorna ao Menu Anterior"
         ...
         EXIT MENU
   END MENU
   CLOSE WINDOW w_pol1201

END FUNCTION

#--------------------------#
FUNCTION pol1201_modificar()
#--------------------------#

   IF pol1201_aceita_simbolos() THEN
      CALL pol1201_grava_simbolos()
   ELSE
      CALL pol1201_exibe_simbolos()
   END IF
...
#--------------------------------#
FUNCTION pol1201_aceita_simbolos()
#--------------------------------#
...
#--------------------------------#
FUNCTION pol1201_grava_simbolos()
#--------------------------------#
   ...
   ELSE
      ...
      CALL log003_err_sql("GRAVAÇÃO","simbolo_1120")
      LET p_retorno = FALSE
   END IF      
   WHENEVER ERROR STOP
...
#--------------------------------#
 FUNCTION pol1201_exibe_simbolos()
#--------------------------------#
...
#-----------------------------------#
 FUNCTION pol1201_emite_relatorio()
#-----------------------------------#
   ...
   FOREACH cq_imp INTO p_simbolo_1120.*
   

      OUTPUT TO REPORT pol1201_relat() 
