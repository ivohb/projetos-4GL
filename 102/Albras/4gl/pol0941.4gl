...
END RECORD 
{DEFINE p_erro ARRAY[999] OF RECORD 
		 		empresa char(2) ,
...
DEFINE 
	...
	WHENEVER ERROR CONTINUE 
		DELETE  man_log_apo_prod912 														#limpa a tabela de erros
...
#------------------------------#
	...
	DEFINE  l_man_log_apo_prod912 ARRAY[50] OF RECORD LIKE man_log_apo_prod912.*
	...
	IF l_tem_pend = 0 THEN
		...
		RETURN TRUE    
	ELSE  
		DECLARE cq_comp SCROLL CURSOR WITH HOLD FOR 	SELECT 	COD_ITEM_COMPON, QTD_NECESSARIA * (p_w_apont_prod.qtd_boas +	p_w_apont_prod.qtd_refug), 
																									COD_LOCAL_BAIXA 
