...
#--------------------------#
  ...
  MENU "OPÇÃO"
    ...
    COMMAND KEY('T') "apont Terceiros"   "Manutenção despesas terceiros."
      HELP 012
      MESSAGE ""
      IF log005_seguranca(p_user,"CDV", 'cdv2000',"MO")  THEN
         IF m_consulta_ativa THEN
...
#------------------------------------#
 DEFINE lr_cdv_intg_fat_781         RECORD LIKE cdv_intg_fat_781.*
 ...
 WHENEVER ERROR STOP
    ...
    WHENEVER ERROR CONTINUE
    INSERT INTO cdv_intg_fat_781 (empresa, viagem, controle,
                                  apropr_desp_acerto, grp_despesa_viagem, tip_despesa_viagem,
                                  sequencia_despesa, seq_alteracao, item,
                                  item_hor, eh_liberacao_pagto, eh_desp_aprovada,
                                  usu_aprov_contab, dat_aprov_contab, hr_aprov_contab,
                                  eh_desp_reembols, motivo_reembolso, qtd_km_faturada,
                                  mot_alteracao_km, qtd_hor_diurnas, qtd_hor_noturnas,
                                  mot_alteracao_hor, usu_aprov_fatura, dat_aprov_fatura,
                                  hr_aprov_fatura, dat_envio_bilhete, hor_envio_bilhete,
                                  origem_integr, certificado, ativ, sistema, dat_apontamento)
                          VALUES (lr_cdv_intg_fat_781.empresa, lr_cdv_intg_fat_781.viagem, lr_cdv_intg_fat_781.controle,
                                  lr_cdv_intg_fat_781.apropr_desp_acerto, lr_cdv_intg_fat_781.grp_despesa_viagem, lr_cdv_intg_fat_781.tip_despesa_viagem,
                                  lr_cdv_intg_fat_781.sequencia_despesa,  lr_cdv_intg_fat_781.seq_alteracao, lr_cdv_intg_fat_781.item,
                                  lr_cdv_intg_fat_781.item_hor, lr_cdv_intg_fat_781.eh_liberacao_pagto, lr_cdv_intg_fat_781.eh_desp_aprovada,
                                  lr_cdv_intg_fat_781.usu_aprov_contab, lr_cdv_intg_fat_781.dat_aprov_contab, lr_cdv_intg_fat_781.hr_aprov_contab,
                                  lr_cdv_intg_fat_781.eh_desp_reembols, lr_cdv_intg_fat_781.motivo_reembolso, lr_cdv_intg_fat_781.qtd_km_faturada,
                                  lr_cdv_intg_fat_781.mot_alteracao_km, lr_cdv_intg_fat_781.qtd_hor_diurnas,  lr_cdv_intg_fat_781.qtd_hor_noturnas,
                                  lr_cdv_intg_fat_781.mot_alteracao_hor, lr_cdv_intg_fat_781.usu_aprov_fatura, lr_cdv_intg_fat_781.dat_aprov_fatura,
                                  lr_cdv_intg_fat_781.hr_aprov_fatura, lr_cdv_intg_fat_781.dat_envio_bilhete, lr_cdv_intg_fat_781.hor_envio_bilhete,
                                  lr_cdv_intg_fat_781.origem_integr, lr_cdv_intg_fat_781.certificado, lr_cdv_intg_fat_781.ativ, lr_cdv_intg_fat_781.sistema, lr_cdv_intg_fat_781.dat_apontamento)
    WHENEVER ERROR STOP
...
#-------------------------------#
  RETURN "$Archive: /Logix/Fontes_Doc/Customizacao/10R2/gps_logist_e_gerenc_de_riscos_ltda/financeiro/controle_despesa_viagem/programas/cdv2000.4gl $|$Revision: 20 $|$Date: 02/01/2014 12:00 $|$Modtime: 22/05/11 14:00 $" #Informações do controle de versão do SourceSafe - Não remover esta linha (FRAMEWORK)
 END FUNCTION
