object frmAparas: TfrmAparas
  Left = 201
  Top = 153
  Width = 1174
  Height = 536
  Caption = 'Relat'#243'rio de entrda de aparas'
  Color = clBtnFace
  ...
  object QRAparas: TQuickRep
    ...
    object TitleBand1: TQRBand
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'RELAT'#211'RIO DE ENTRDA DE APARAS'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -24
    ...
    object QRGroup1: TQRGroup
      ...
      Size.Values = (
        7.937500000000000000
        2865.437500000000000000)
      Expression = 'sqlAparas.cod_fornecedor'
      FooterBand = QRBand2
      Master = QRAparas
    ...
    object QRBand2: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(sqlAparas.qtd_declarad_nf)'
        FontSize = 10
      end
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(sqlAparas.peso_balanca)'
        FontSize = 10
      end
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(sqlAparas.dif_qtd)'
        FontSize = 10
      end
    end
  ...
  object sqlAparas: TADOQuery
    Connection = banco
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      ''
      'select relat_pol1277_885.*, empresa.den_empresa, '
      '       fornecedor.raz_social, item.den_item_reduz'
      '  from relat_pol1277_885, empresa, fornecedor, item'
      ' where relat_pol1277_885.cod_empresa = empresa.cod_empresa '
      '   and relat_pol1277_885.cod_empresa = item.cod_empresa'
      '   and relat_pol1277_885.cod_item = item.cod_item '
      
        '   and relat_pol1277_885.cod_fornecedor = fornecedor.cod_fornece' +
        'dor')
    Left = 952
    Top = 384
    object sqlAparascod_empresa: TStringField
      FieldName = 'cod_empresa'
      Size = 2
    end
    object sqlAparascod_fornecedor: TStringField
      FieldName = 'cod_fornecedor'
      Size = 15
    end
    object sqlAparasnum_aviso_rec: TIntegerField
      FieldName = 'num_aviso_rec'
    end
    object sqlAparasnum_seq_ar: TIntegerField
      FieldName = 'num_seq_ar'
    end
    object sqlAparasdat_entrada_nf: TDateTimeField
      FieldName = 'dat_entrada_nf'
    end
    object sqlAparasnum_nf: TIntegerField
      FieldName = 'num_nf'
    end
    object sqlAparascod_item: TStringField
      FieldName = 'cod_item'
      Size = 15
    end
    object sqlAparasqtd_declarad_nf: TBCDField
      FieldName = 'qtd_declarad_nf'
      Precision = 10
      Size = 3
    end
    object sqlAparaspre_unit_nf: TBCDField
      FieldName = 'pre_unit_nf'
      Precision = 7
      Size = 2
    end
    object sqlAparasval_liquido_item: TBCDField
      FieldName = 'val_liquido_item'
      Precision = 12
      Size = 2
    end
    object sqlAparaspeso_balanca: TBCDField
      FieldName = 'peso_balanca'
      Precision = 10
      Size = 3
    end
    object sqlAparaspreco_cotacao: TBCDField
      FieldName = 'preco_cotacao'
      Precision = 8
      Size = 2
    end
    object sqlAparasval_cotacao: TBCDField
      FieldName = 'val_cotacao'
      Precision = 12
      Size = 2
    end
    object sqlAparasdif_qtd: TBCDField
      FieldName = 'dif_qtd'
      Precision = 10
      Size = 3
    end
    object sqlAparasden_status: TStringField
      FieldName = 'den_status'
      Size = 15
    end
    object sqlAparasusuario: TStringField
      FieldName = 'usuario'
      Size = 8
    end
    object sqlAparasden_empresa: TStringField
      FieldName = 'den_empresa'
      FixedChar = True
      Size = 36
    end
    object sqlAparasraz_social: TStringField
      FieldName = 'raz_social'
      FixedChar = True
      Size = 50
    end
    object sqlAparasden_item_reduz: TStringField
      FieldName = 'den_item_reduz'
      FixedChar = True
      Size = 18
    end
  end
  object sqlPeriodo: TADOQuery
    Connection = banco
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'select dat_ini, dat_fim  from periodo_relat_885 where nom_progra' +
        'ma = '#39'POL1277'#39)
    Left = 992
    Top = 384
    object sqlPeriododat_ini: TDateTimeField
      FieldName = 'dat_ini'
    end
    object sqlPeriododat_fim: TDateTimeField
      FieldName = 'dat_fim'
    end
  end
end
