...
public class App {
	...
	public static void main(String[] args) {
		...
		//new App().testeDownlaodPedido();
		
		new App().testeEnvioNotaPedido();
		
		//new App().testeEnvioNotaCancelada();
	...
	public void testeDownlaodPedido() {
	...
	public void testeEnvioNotaPedido() {
		String xml = "<NewDataSet>\r\n" + 
				"<notas>\r\n" + 
				"<num_nota>000124219</num_nota>\r\n" + 
				"<serie>1 </serie>\r\n" + 
				"<num_pedido>219653 </num_pedido>\r\n" + 
				"<dt_emissao>2020-04-16T12:00:00-00:00</dt_emissao>\r\n" + 
				"<tipo_operacao>1</tipo_operacao>\r\n" + 
				"<num_nota_origem/>\r\n" + 
				"<serie_origem/>\r\n" + 
				"<quant>15</quant>\r\n" + 
				"<placa_veiculo> ILQ3139</placa_veiculo>\r\n" + 
				"<vr_icms_frete>40.8</vr_icms_frete>\r\n" + 
				"</notas>\r\n" + 
				"</NewDataSet>";
		
		try {
			String retorno = new MetodosSoap("05872541000123", "mds123",false).enviaNota(xml);
			System.out.println(retorno);
		} catch (RemoteException e) {
			System.out.println("Erro envio de Notas : "+e.getMessage());
		}

	}
	
	
	public void testeEnvioNotaCancelada() {
		String xml = "<NewDataSet>\r\n" + 
				"<NotasCanceladas>\r\n" + 
				"<num_nota>73421</num_nota>\r\n" + 
				"<serie>1 </serie>\r\n" + 
				"<dt_cancelato>2020-04-24T08:34:11.7-03:00</dt_cancelato>\r\n" + 
				"</NotasCanceladas>\r\n" + 
				"</NewDataSet>";
		
		try {
			String retorno = new MetodosSoap("05872541000123", "mds123",false).enviaNotaCancelada(xml);
			System.out.println(retorno);
		} catch (RemoteException e) {
			System.out.println("Erro envio de Notas Canceladas : "+e.getMessage());
		}

	}
	
	/*public void testeConexao() throws ClassNotFoundException, SQLException {
		try{
