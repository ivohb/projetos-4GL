...
#----------------------------------------#
    ...
    CALL _ADVPL_set_property(m_lupa_item,"CLICK_EVENT","pol1379_zoom_embal")
...
#-------------------------------#
   ...
   DEFINE l_compon, l_ind  SMALLINT
...
#-------------------------------#
   ...
   INSERT INTO emabalagem_padrao_405(
      id_embal, cod_cliente, cod_item_embal)
   VALUES(m_id_embal, mr_campos.cod_cliente, mr_campos.cod_item)
...
#---------------------------#
FUNCTION pol1379_zoom_embal()#
#---------------------------#
   
   IF pol1379_zoom_item() THEN
      LET mr_campos.cod_item = m_codigo
...
#-----------------------------#
   ...
   IF NOT pol1379_le_item(mr_campos.cod_item) THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      RETURN FALSE
   END IF
