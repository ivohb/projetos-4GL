...
#------------------------------------#
FUNCTION cdv2019_par_fiscal(lr_param)#
#------------------------------------#
   ...
   IF NOT cdv2019_cria_tabelas() THEN
      RETURN m_msg
   END IF

   IF NOT cdv2019_le_param_fisc() THEN
      RETURN m_msg
   END IF
...
#------------------------------#
FUNCTION cdv2019_le_param_fisc()
#------------------------------#
   
   IF NOT cdv2019_le_item()  THEN 
      RETURN FALSE	
   END IF 
   ...
   FOREACH  cq_tributos INTO p_tributo_benef
      ...
      FOREACH cq_acesso INTO p_seq_acesso
         ...
         CALL cdv2019_pega_chave()

	       IF NOT cdv2019_checa_tributo()  THEN 
	          RETURN FALSE	
         END IF 
...
#-------------------------------#
FUNCTION cdv2019_checa_tributo()
#-------------------------------#
   ...
   FOREACH cq_chave INTO p_chave
      ...
      WHEN 'REGIAO' 
         IF NOT cdv2019_le_obf_regiao() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_CLASSIF' 
         IF NOT cdv2019_le_obf_cl_fisc() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_ITEM' 
         IF NOT cdv2019_le_obf_fisc_item() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_CLIENTE' 
         IF NOT cdv2019_le_obf_fisc_cli() THEN
            RETURN FALSE
         END IF
...
#-------------------------------#
FUNCTION cdv2019_le_obf_regiao()
#-------------------------------#
...
#-------------------------------#
FUNCTION cdv2019_le_obf_cl_fisc()
#-------------------------------#
...
#---------------------------------#
FUNCTION cdv2019_le_obf_fisc_item()
#---------------------------------#
...
#---------------------------------#
FUNCTION cdv2019_le_obf_fisc_cli()
#---------------------------------#
