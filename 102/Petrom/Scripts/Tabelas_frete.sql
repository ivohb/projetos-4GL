...
create table par_frete_455 (
   ...
   pct_tolerancia     decimal(5,2),  --tolerância para valores divergentes
   pct_seguro         decimal(6,2),  --pct seguro para geração do relatório
...
CREATE TABLE calculo_conhec_455(
  ...
  tip_cobranca   char(01),        --C=Peso mínimo N=Normal
