...
$t_val_bonus=0;
 ...
 { 
  ...
  //Marco gestor e supervisor, pois logo abaixo dá um next no resultset.
  if(trim($mat["nivel"])=="G")
  {
   $gestor="S";
  }else{
  ...
  if($tipo=="K")
   ...
   $bonus=0;
   if($gestor!="S" && $rep_ant != "127" && $rep_ant != "198") // PROVISÓRIO (criar um campo no cadastro de repres para indicar se tem bonus ou não)
   	{
