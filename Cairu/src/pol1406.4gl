...
#---------------------------------------#
    ...
    CALL _ADVPL_set_property(l_label,"TEXT","Envio automático:")    

    LET m_env_aut = _ADVPL_create_component(NULL,"LCOMBOBOX",m_pan_emp)     
    CALL _ADVPL_set_property(m_env_aut,"POSITION",900,10)     
...
#--------------------------------------#
    ...
    LET l_tabcolumn = _ADVPL_create_component(NULL,"LTABLECOLUMNEX",m_brz_emp)
    CALL _ADVPL_set_property(l_tabcolumn,"HEADER","Enviar")
    CALL _ADVPL_set_property(l_tabcolumn,"COLUMN_WIDTH",50)    
    CALL _ADVPL_set_property(l_tabcolumn,"VARIABLE","enviar")
...
#-------------------------------------#
   ...
   LET mr_emp.enviar = ma_emp[l_linha].enviar
