<?php
 ...
 if(file_exists($argv[1])) 
 {
  ...
  for($x=0;$x<$ac;$x++)
  {
   ...
   $sql = 'insert into lt1200_imp_fame (cod_empresa,num_lote,cod_sistema,dat_refer,num_conta,ies_tipo_lanc,dat_movto,val_lanc,cod_rateio,cod_hist,tex_compl,ies_sit_lanc,cod_lin_prod,cod_lin_recei,cod_seg_merc,cod_cla_uso) values('.'"'.$valor_campo[0] ;
