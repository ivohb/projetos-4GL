...
#          p_versao             CHAR(17),
   ...
   DEFINE p_peca_gemea_5054 RECORD LIKE peca_gemea_5054.*

   DEFINE p_tela          RECORD
          cod_peca_princ  LIKE peca_gemea_5054.cod_peca_princ
   END RECORD
    
   DEFINE pr_gemea        ARRAY[200] OF RECORD
          cod_peca_gemea  LIKE peca_gemea_5054.cod_peca_gemea,
          qtd_peca_gemea  LIKE peca_gemea_5054.qtd_peca_gemea,
...
MAIN
   ...
   DEFER INTERRUPT
   LET p_versao = "pol1216-10.02.00"
   INITIALIZE p_nom_help TO NULL  
   CALL log140_procura_caminho("pol1216.iem") RETURNING p_nom_help
...
#   CALL log001_acessa_usuario("VDP")
  CALL log001_acessa_usuario("ESPEC999","")
   ...
   IF p_status = 0  THEN
      CALL pol1216_controle()
   END IF
END MAIN

#--------------------------#
 FUNCTION pol1216_controle()
#--------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol1216") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol1216 AT 2,2 WITH FORM p_nom_tela
   ...
   MENU "OPCAO"
      COMMAND "Incluir" "Inclui dados na Tabela"
         ...
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1216_incluir() RETURNING p_status
         IF p_status THEN
      ...
      COMMAND "Modificar" "Modifica/Inclui dados na Tabela"
         ...
         LET INT_FLAG = 0
         IF p_ies_cons THEN
            CALL pol1216_modificar() RETURNING p_status
            IF p_status THEN
      ...
      COMMAND "Excluir" "Exclui Todos os dados da Tela"
         ...
         IF p_ies_cons THEN
            ...
            ELSE
               CALL pol1216_excluir() RETURNING p_status
               IF p_status THEN
      ...
      COMMAND "Seguinte" "Exibe o Proximo Item Encontrado na Consulta"
         ...
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1216_paginacao("SEGUINTE")
      COMMAND "Anterior" "Exibe o Item Anterior Encontrado na Consulta"
         HELP 006
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1216_paginacao("ANTERIOR")
      COMMAND "Listar" "Lista os Dados do Cadastro"
         HELP 003
         MESSAGE ""
         IF NOT pol1216_informar() THEN 
            ERROR "Operação Cancelada !!!"
            CONTINUE MENU
         END IF
         IF log005_seguranca(p_user,"VDP","pol1216","MO") THEN
            IF log028_saida_relat(18,35) IS NOT NULL THEN
               MESSAGE " Processando a Extracao do Relatorio..." 
                  ATTRIBUTE(REVERSE)
               IF p_ies_impressao = "S" THEN
                  IF g_ies_ambiente = "U" THEN
                     START REPORT pol1216_relat TO PIPE p_nom_arquivo
                  ELSE
                     CALL log150_procura_caminho ('LST') RETURNING p_caminho
                     LET p_caminho = p_caminho CLIPPED, 'pol1216.tmp'
                     START REPORT pol1216_relat  TO p_caminho
                  END IF
               ELSE
                  START REPORT pol1216_relat TO p_nom_arquivo
               END IF
               CALL pol1216_emite_relatorio()   
               IF p_count = 0 THEN
                  ERROR "Nao Existem Dados para serem Listados" 
               ELSE
                  ERROR "Relatorio Processado com Sucesso" 
               END IF
               FINISH REPORT pol1216_relat   
            ELSE
               CONTINUE MENU
            END IF                                                     
            IF p_ies_impressao = "S" THEN
      ...
      COMMAND "Fim"       "Retorna ao Menu Anterior"
         ...
         EXIT MENU
   END MENU
   CLOSE WINDOW w_pol1216

END FUNCTION

#-----------------------#
FUNCTION pol1216_incluir()
#-----------------------#


   IF pol1216_aceita_chave() THEN 
      IF pol1216_aceita_itens() THEN
         CALL pol1216_grava_itens()
      END IF
   END IF
   RETURN(p_retorno)
...
#--------------------------#
FUNCTION pol1216_modificar()
#--------------------------#

   IF pol1216_aceita_itens() THEN
      CALL pol1216_grava_itens()
   ELSE
      CALL pol1216_exibe_gemeas()
   END IF
...
#-----------------------------#
FUNCTION pol1216_aceita_chave()
#-----------------------------#

   CALL log006_exibe_teclas("01 02 07",p_versao)
   CURRENT WINDOW IS w_pol1216
   CLEAR FORM
   DISPLAY p_cod_empresa TO cod_empresa
...
#-----------------------------#
   ...
   ELSE
      ...
      CALL log003_err_sql("GRAVAÇÃO","peca_gemea_5054")
      LET p_retorno = FALSE
   END IF      
   WHENEVER ERROR STOP
...
#-------------------------#
FUNCTION pol1216_informar() 
#-------------------------#

   CLEAR FORM
   DISPLAY p_cod_empresa TO cod_empresa
   CONSTRUCT BY NAME where_clause ON 
      peca_gemea_5054.cod_peca_princ
...
#------------------------#
   ...
   IF log004_confirm(18,35) THEN
      ...
      ELSE
         CALL log085_transacao("ROLLBACK")
         CALL log003_err_sql("DELEÇÃO","peca_gemea_5054")
      END IF
   END IF
   WHENEVER ERROR STOP
   RETURN(p_retorno)
...
#--------------------------#
   ...
   IF INT_FLAG <> 0 THEN
      ...
      CALL pol1216_exibe_dados()
      ERROR "Consulta Cancelada"
      RETURN
   END IF

   LET sql_stmt = "SELECT cod_peca_princ FROM peca_gemea_5054 ",
...
#-----------------------------------#
 FUNCTION pol1216_paginacao(p_funcao)
#-----------------------------------#
...
#-----------------------------------#
 FUNCTION pol1216_emite_relatorio()
#-----------------------------------#
   ...
   LET sql_stmt = "SELECT UNIQUE cod_peca_princ FROM peca_gemea_5054 ",
                  " WHERE ", where_clause CLIPPED,  
                  "   AND cod_empresa = '",p_cod_empresa,"' ",               
                  "ORDER BY cod_peca_princ"
   ...
   FOREACH cq_padrao INTO p_cod_peca_princ
      ...
      OUTPUT TO REPORT pol1216_relat(p_cod_peca_princ) 
...
#-------------------------------------#
 REPORT pol1216_relat(p_cod_peca_princ)
#-------------------------------------#

   DEFINE p_cod_peca_princ LIKE peca_gemea_5054.cod_peca_princ
   ...
   FORMAT
      ...
      PAGE HEADER  
         ...
         PRINT 
         PRINT COLUMN 001, "pol1216                RELATORIO DE PECAS SIMETRICAS"
         PRINT COLUMN 001, "--------------------------------------------------------------------------------"
