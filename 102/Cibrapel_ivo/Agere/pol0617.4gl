...
# SISTEMA.: VENDAS                                                  #
# PROGRAMA: pol0617                                                 #
# MODULOS.: pol0617-LOG0010-LOG0030-LOG0040-LOG0050-LOG0060         #
#           LOG0090-LOG0280-LOG1200-LOG1300-LOG1400-LOG1500         #
# OBJETIVO: CADASTRO DE GRAMATURA - CIBRAPEL                        #
...
#-----------------------------------#
   ...
   SELECT cod_empresa,
          ...
          gramatura,
          peso_minimo / 1000
     INTO p_gramatura_885.cod_empresa,
          p_gramatura_885.cod_item,
          p_gramatura_885.gramatura,
          p_gramatura_885.peso_minimo                                            
     FROM gramatura_885
    WHERE cod_empresa = p_cod_empresa
      AND cod_item    = p_gramatura_885.cod_item
