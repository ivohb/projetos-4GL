...
{ TABLE "informix".rovman_apont_454 row size = 186 number of columns = 29 index size 
              = 11 }
create table "informix".rovman_apont_454 
  (
...
revoke all on "informix".rovman_apont_454 from "public" as "informix";


create index "informix".ix1_rovman_apont_454 on "informix".rovman_apont_454 
