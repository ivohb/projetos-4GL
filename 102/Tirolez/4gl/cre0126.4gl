...
#   Fiz os ajustes necesários para funiconar corretamente  (3h)   #
#-----------------------------------------------------------------#

{
Esta sem validação o campo Faixa de produto utilizada para validar os produtos no coletor:
1-Este campo sempre tem que ter numeros de 01 a 99
2-a tabela que ele deve validar é a tabela tirolez_coletor_item_validade  
e no campo tabela, se existir pode aceitar, como nesta tabela é tabela por produto, 
logicamente teremos a tabela 01 com mais de 140 registros, sendo assim a unica 
consistência é ver se existe nesta tabela esta numero de tabela existe e mais nada.
...
#----------------------------------------#
 ...
 {     AFTER FIELD cod_ean1
    ...
    AFTER FIELD faixa_produto
       ...
       IF l_count = 0 THEN
          ERROR 'Faixa de produto inválida.'
          NEXT FIELD faixa_produto
       END IF
