#-----------------------------------------------------------------------#
# SISTEMA.: INTEGRAÇÃO LOGIX E TRIM                                     #
# PROGRAMA: pol0622                                                     #
...
MAIN
   ...
   DEFER INTERRUPT 
   LET p_versao = "pol0622-05.10.00"
   INITIALIZE p_nom_help TO NULL  
   CALL log140_procura_caminho("pol0622.iem") RETURNING p_nom_help
   ...
   IF p_status = 0 THEN
      CALL pol0622_controle()
   END IF

END MAIN

#--------------------------#
 FUNCTION pol0622_controle()
#--------------------------#
   
   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL
   CALL log130_procura_caminho("pol0622") RETURNING p_nom_tela
   LET  p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol0622 AT 6,20 WITH FORM p_nom_tela 
      ATTRIBUTE(BORDER, MESSAGE LINE LAST, PROMPT LINE LAST)
   DISPLAY p_cod_empresa TO cod_empresa

   IF NOT pol0622_le_empresas() THEN
      RETURN
   END IF

   CALL pol0622_libera_ordens()

   CLOSE WINDOW w_pol0622

END FUNCTION

#-----------------------------#
FUNCTION pol0622_le_empresas()
#-----------------------------#
...
#-----------------------------#
FUNCTION pol0622_libera_ordens()
#-----------------------------#
   ...
   FOREACH cq_prod INTO 
      ...
      FOR p_ind = 1 TO 2
          ...
          IF p_ies_baixa_comp = '1' THEN       
             IF NOT pol0622_transf_mp() THEN
                CALL log085_transacao("ROLLBACK")
                RETURN
             END IF 
          END IF

          IF NOT pol0622_atualiza_tabs() THEN
             CALL log085_transacao("ROLLBACK")
             RETURN
          END IF
      
          IF p_ind = 1 THEN
             IF NOT pol0622_le_op_chapa() THEN
                RETURN
             END IF
             IF p_op_chapa IS NULL THEN
                EXIT FOR
             END IF
          END IF
...
#-----------------------------#
FUNCTION pol0622_le_op_chapa()
#-----------------------------#

   DEFINE p_cod_compon     LIKE ordens.cod_item,
   ...
   FOREACH cq_op INTO 
      ...
      IF STATUS <> 0 THEN
         CALL log003_err_sql("LEITURA","item_vdp")
         RETURN FALSE
      END IF
      ...
      IF STATUS = 0 THEN
         LET p_op_chapa = p_num_ordem
         LET p_cod_item = p_cod_compon
         EXIT FOREACH
      ELSE
         IF STATUS <> 100 THEN
            CALL log003_err_sql("LEITURA","grupo_chapa_885")
            RETURN FALSE
         END IF
      END IF
...
#-------------------------------#
FUNCTION pol0622_atualiza_tabs()
#-------------------------------#
...
#---------------------------#
   ...
   FOREACH cq_neces INTO 
      ...
      IF NOT pol0622_movimenta_estoque() THEN
         RETURN FALSE
      END IF
...
#----------------------------------#
FUNCTION pol0622_movimenta_estoque()
#----------------------------------#
   ...
   FOREACH cq_lot INTO p_estoque_lote_ender.*
      ...
      IF p_novo_saldo = 0 THEN
         IF NOT pol0622_deleta_lote() THEN
            RETURN FALSE
         END IF
      ELSE
         IF NOT pol0622_atualiza_lote() THEN
            RETURN FALSE
         END IF
      END IF
        
      IF NOT pol0622_atualiza_local_prod() THEN
         RETURN FALSE
      END IF
   ...
   IF p_tot_neces > 0 THEN
      IF NOT pol0622_grava_trans_penden() THEN
         RETURN FALSE
      END IF
   END IF
...
#------------------------------------#      
FUNCTION pol0622_grava_trans_penden()
#------------------------------------#      
...
#------------------------------#
 FUNCTION pol0622_atualiza_lote()
#------------------------------#
...
#--------------------------------------#
FUNCTION  pol0622_atualiza_local_prod()
#--------------------------------------#
   ...
   IF STATUS = 100 THEN
      IF NOT pol0622_insere_local_prod() THEN
         RETURN FALSE
      END IF
   ELSE
      IF STATUS = 0 THEN
         IF NOT pol0622_altera_local_prod() THEN
            RETURN FALSE
         END IF
      ELSE
         CALL log003_err_sql("LEITURA","ESTOQUE_LOTE_ENDER")
   ...
   IF NOT pol0622_insere_est_trans() THEN
      RETURN FALSE
   END IF
...
#-----------------------------------#
FUNCTION  pol0622_insere_local_prod()
#-----------------------------------#
...
#-----------------------------------#
FUNCTION  pol0622_altera_local_prod()
#-----------------------------------#
...
#----------------------------------#
 FUNCTION pol0622_insere_est_trans()
#----------------------------------#
   ...
   LET mr_estoque_trans.num_prog           = "pol0622"
   ...
   IF NOT pol0622_ins_est_trans_end() THEN
      RETURN FALSE
   ELSE
      RETURN TRUE
   END IF
...
#------------------------------------#
 FUNCTION pol0622_ins_est_trans_end()
#------------------------------------#
   ...
   LET mr_estoque_trans_end.num_prog         = "pol0622"
  ...
  INSERT INTO estoque_auditoria 
     VALUES(p_cod_empresa, m_num_transac_orig, p_user, CURRENT,'pol0622')
