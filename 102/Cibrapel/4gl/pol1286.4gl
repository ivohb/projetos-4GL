...
#----------------------#
   ...
   IF NOT pol1286_parametros() THEN
   ...
   INPUT ARRAY pr_transpor
      ...
      AFTER FIELD cod_transpor
         ...
         DECLARE cq_transpor CURSOR FOR                                                                           
          ...
          SELECT DISTINCT nom_cliente, cod_tip_cli                                                                            
            FROM clientes                                                                                         
           WHERE cod_cliente = pr_transpor[p_index].cod_transpor                                                    
                                                                                                                
         FOREACH cq_transpor                                                                                      
            INTO pr_transpor[p_index].nom_transpor, p_cod_tip_cli                                                                
         ...
         IF pr_transpor[p_index].cod_transpor IS NOT NULL THEN 
