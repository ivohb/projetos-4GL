...
#-------------------------------#
 ...
 RETURN "$Archive: /Logix/Fontes_Doc/Customizacao/10R2/gps_logist_e_gerenc_de_riscos_ltda/financeiro/controle_despesa_viagem/programas/cdv2000.4gl $|$Revision: 22 $|$Date: 23/02/2015 11:30 $|$Modtime: 22/05/11 14:00 $" #Informações do controle de versão do SourceSafe - Não remover esta linha (FRAMEWORK)
