...
#----------------------#
    ...
    CALL _ADVPL_set_property(l_find,"CONFIRM_EVENT","pol1393_find_conf")
    CALL _ADVPL_set_property(l_find,"CANCEL_EVENT","pol1393_find_canc")

    LET l_first = _ADVPL_create_component(NULL,"LFIRSTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_first,"EVENT","pol1393_first")

    LET l_previous = _ADVPL_create_component(NULL,"LPREVIOUSBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_previous,"EVENT","pol1393_previous")

    LET l_next = _ADVPL_create_component(NULL,"LNEXTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_next,"EVENT","pol1393_next")

    LET l_last = _ADVPL_create_component(NULL,"LLASTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_last,"EVENT","pol1393_last")
   ...
   CALL pol1393_ativa_campo(FALSE)
...
#----------------------------------------#
    ...
    CALL _ADVPL_set_property(m_carga,"POSITION",700,10)     
    CALL _ADVPL_set_property(m_carga,"VARIABLE",mr_cabec,"dat_carga")

    LET l_label = _ADVPL_create_component(NULL,"LLABEL",m_pnl_info)
    CALL _ADVPL_set_property(l_label,"POSITION",820,10) 
    CALL _ADVPL_set_property(l_label,"TEXT","Hr import:")    

    LET m_hora = _ADVPL_create_component(NULL,"LTEXTFIELD",m_pnl_info)     
    CALL _ADVPL_set_property(m_hora,"POSITION",870,10)     
    CALL _ADVPL_set_property(m_hora,"LENGTH",8) 
    CALL _ADVPL_set_property(m_hora,"VARIABLE",mr_cabec,"hor_carga")

    LET l_label = _ADVPL_create_component(NULL,"LLABEL",m_pnl_info)
    CALL _ADVPL_set_property(l_label,"POSITION",960,10) 
    CALL _ADVPL_set_property(l_label,"TEXT","ID Arquivo:")    

    LET m_ident = _ADVPL_create_component(NULL,"LNUMERICFIELD",m_pnl_info)     
    CALL _ADVPL_set_property(m_ident,"POSITION",1020,10)     
    CALL _ADVPL_set_property(m_ident,"LENGTH",5) 
    CALL _ADVPL_set_property(m_ident,"VARIABLE",mr_cabec,"id_arquivo")

    LET l_label = _ADVPL_create_component(NULL,"LLABEL",m_pnl_info)
    CALL _ADVPL_set_property(l_label,"POSITION",1080,10) 
    CALL _ADVPL_set_property(l_label,"TEXT","Num AD:")    

    LET m_ad = _ADVPL_create_component(NULL,"LNUMERICFIELD",m_pnl_info)     
    CALL _ADVPL_set_property(m_ad,"POSITION",1130,10)     
    ...
    CALL _ADVPL_set_property(m_ap,"POSITION",1250,10)     
...
#-------------------------------------#
   ...
   DEFINE l_status       SMALLINT
    ...
    CALL _ADVPL_set_property(m_hora,"ENABLE",l_status) 
    CALL _ADVPL_set_property(m_ident,"ENABLE",l_status) 
...
#------------------------------#
   ...
   #LET p_comando = 'E:\\Totvs\\temp\\pgi1393.exe ' , l_param 
...
#----------------------#
   ...
   CALL pol1393_ativa_campo(TRUE)
   CALL _ADVPL_set_property(m_carga,"GET_FOCUS")
...
#---------------------------#
FUNCTION pol1393_find_conf()#
#---------------------------#

   CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",'')
   CALL pol1393_monta_select()
   LET m_msg = NULL
   
   IF NOT pol1393_exec_select() THEN
...
#------------------------------#
FUNCTION pol1393_monta_select()#
#------------------------------#
    
    LET m_query =
        " SELECT DISTINCT a.id_arquivo FROM  arquivo_concur a, itens_concur i ",
        " WHERE a.cod_empresa = i.cod_empresa AND a.id_arquivo = i.id_arquivo ",
        " AND a.cod_empresa = '",p_cod_empresa,"' "
    
    IF mr_cabec.dat_carga IS NOT NULL THEN
       LET m_query = m_query, " AND a.dat_carga = '",mr_cabec.dat_carga,"' "
    END IF
    
    IF mr_cabec.hor_carga IS NOT NULL THEN
       LET m_query = m_query, " AND a.hor_carga = '",mr_cabec.hor_carga,"' "
    END IF

    IF mr_cabec.id_arquivo IS NOT NULL THEN
       LET m_query = m_query, " AND a.id_arquivo = ",mr_cabec.id_arquivo
    END IF
    ...
    LET m_query = m_query, " ORDER BY a.id_arquivo "
    
END FUNCTION
       
#-----------------------------#
FUNCTION pol1393_exec_select()#
#-----------------------------#
   ...
   FETCH cq_cons INTO m_id_arquivo
   ...
   IF NOT pol1393_exibe_dados() THEN
      RETURN FALSE
   END IF
...
#----------------------------------#
FUNCTION pol1393_paginacao(l_opcao)#
#----------------------------------#
   
   DEFINE l_opcao CHAR(01),
          l_achou SMALLINT

   IF NOT pol1393_ies_cons() THEN
      RETURN FALSE
   END IF
...
#-----------------------#
FUNCTION pol1393_first()#
#-----------------------#

   IF NOT pol1393_paginacao('F') THEN
      RETURN FALSE
   END IF
...
#----------------------#
FUNCTION pol1393_next()#
#----------------------#

   IF NOT pol1393_paginacao('N') THEN
      RETURN FALSE
   END IF
...
#--------------------------#
FUNCTION pol1393_previous()#
#--------------------------#

   IF NOT pol1393_paginacao('P') THEN
      RETURN FALSE
   END IF
...
#----------------------#
FUNCTION pol1393_last()#
#----------------------#

   IF NOT pol1393_paginacao('L') THEN
      RETURN FALSE
   END IF
