...
#----------------------#
   ...
   IF NOT pol0938_le_empresa_ofic() THEN
      RETURN
   END IF
...
#--------------------------------#
FUNCTION pol0938_le_empresa_ofic()
#--------------------------------#
...
#---------------------------------------#
   ...
   INPUT BY NAME p_familia_baixar_885.* WITHOUT DEFAULTS
      ...
      IF STATUS = 100 THEN 
         ERROR 'Famìlia não cadastrada na tabela familia!!!'
         NEXT FIELD cod_familia
      ELSE
         IF STATUS <> 0 THEN 
