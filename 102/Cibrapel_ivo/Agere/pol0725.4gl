...
# PROGRAMA: POL0725                                                 #
# MODULOS.: POL0725 - LOG0010 - LOG0030 - LOG0040 - LOG0050         #
...
#--------------------------#
  ...
  OPEN WINDOW w_POL0725 AT 2,5 WITH FORM p_nom_tela 
...
#-----------------------------------#
  ...
  DEFINE pr_lista       ARRAY[3000]
     OF RECORD
         cod_cliente LIKE desc_nat_oper_912.cod_cliente,
