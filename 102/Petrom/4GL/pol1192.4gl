...
# SISTEMA.: LOGIX                                                   #
# PROGRAMA: pol1192                                                 #
# OBJETIVO: PORCENTAGEM P/ APLICAÇÃO NO FATURAMENTO                 #
# AUTOR...: IVO BL                                                  #
# DATA....: 26/04/2013                                              #
#-------------------------------------------------------------------#
...
DEFINE pr_percent         ARRAY[100] OF RECORD
       valor_de           LIKE pct_faturamento_455.valor_de,    
       valor_ate          LIKE pct_faturamento_455.valor_ate,   
       pct_aplicado       LIKE pct_faturamento_455.pct_aplicado
END RECORD
...
#----------------------#
 FUNCTION pol1192_menu()
#----------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol1192") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol1192 AT 2,2 WITH FORM p_nom_tela
   ...
   MENU "OPCAO"
      COMMAND "Incluir" "Inclui dados na tabela."
         CALL pol1192_inclusao() RETURNING p_status
         IF p_status THEN
            ERROR 'Inclusão efetuada com sucesso !!!'
            LET p_ies_cons = FALSE
         ELSE
            CALL pol1192_limpa_tela()
            ERROR 'Operação cancelada !!!'
         END IF 
      COMMAND "Consultar" "Consulta dados da tabela."
         IF pol1192_consulta() THEN
      ...
      COMMAND "Modificar" "Modifica dados da tabela."
         IF p_ies_cons THEN
            CALL pol1192_modificacao() RETURNING p_status  
            IF p_status THEN
      ...
      COMMAND "Excluir" "Exclui dados da tabela."
         IF p_ies_cons THEN
            CALL pol1192_exclusao() RETURNING p_status
            IF p_status THEN
      ...
      COMMAND "Fim"       "Retorna ao menu anterior."
         EXIT MENU
   END MENU
   CLOSE WINDOW w_pol1192

END FUNCTION

#----------------------------#
FUNCTION pol1192_limpa_tela()#
#----------------------------#
...
#--------------------------#
   ...
   IF NOT pol1192_le_itens() THEN
      RETURN FALSE
   END IF
   
   IF pol1192_edita_itens() THEN      
      IF pol1192_grava_dados() THEN    
         LET p_ies_cons = TRUE
         RETURN TRUE                                                                    
      END IF                                                                      
   END IF
...
#------------------------------#     
   ...
   IF INT_FLAG THEN
      IF NOT p_ies_cons THEN
         CALL pol1192_limpa_tela()
      ELSE
        CALL pol1192_le_itens() RETURNING p_status
      END IF
      RETURN FALSE
   END IF
...
#-----------------------------#
 FUNCTION pol1192_grava_dados()
#-----------------------------#
   
   CALL log085_transacao("BEGIN")
   
   DELETE FROM pct_faturamento_455 
    
   IF STATUS <> 0 THEN
      CALL log003_err_sql("Deletando", "pct_faturamento_455  ")
   ...
   FOR p_ind = 1 TO ARR_COUNT()
       IF pr_percent[p_ind].valor_ate IS NOT NULL THEN
		       ...
		       INSERT INTO pct_faturamento_455  
		       ...
		       IF STATUS <> 0 THEN 
		          CALL log003_err_sql("Incluindo", "pct_faturamento_455  ")
		          CALL log085_transacao("ROLLBACK")
		          RETURN FALSE
		       END IF
       END IF
...
#--------------------------------#
 FUNCTION pol1192_prende_tabela()
#--------------------------------#
   
   CALL log085_transacao("BEGIN")
   
   LOCK TABLE pct_faturamento_455 IN EXCLUSIVE MODE

   IF STATUS <> 0 THEN
      CALL log003_err_sql("Bloqueando","pct_faturamento_455  ")
      RETURN FALSE
   END IF
...
#-----------------------------#
 FUNCTION pol1192_modificacao()
#-----------------------------#

   LET p_retorno = FALSE
   LET p_opcao   = 'M'
   
   IF pol1192_prende_tabela() THEN
      IF pol1192_edita_itens() THEN
         IF pol1192_grava_dados() THEN
            LET p_retorno = TRUE
         END IF
...
#--------------------------#
   ...
   IF pol1192_prende_tabela() THEN
      ...
      IF STATUS = 0 THEN               
         ...
         LET p_retorno = TRUE                       
      ELSE
         CALL log003_err_sql("Excluindo","pct_faturamento_455  ")
      END IF
   END IF
...
#--------------------------#     
   ...
   IF NOT pol1192_escolhe_saida() THEN
   		RETURN 
   END IF
      
   IF NOT pol1192_le_den_empresa() THEN
      RETURN
   END IF   
   ...
   OUTPUT TO REPORT pol1192_relat() 

   LET p_count = 1
      

   FINISH REPORT pol1192_relat   
...
#-------------------------------#
 FUNCTION pol1192_escolhe_saida()
#-------------------------------#
   ...
   IF p_ies_impressao = "S" THEN
      IF g_ies_ambiente = "U" THEN
         START REPORT pol1192_relat TO PIPE p_nom_arquivo
      ELSE
         CALL log150_procura_caminho ('LST') RETURNING p_caminho
         LET p_caminho = p_caminho CLIPPED, 'pol1192.tmp'
         START REPORT pol1192_relat  TO p_caminho
      END IF
   ELSE
      START REPORT pol1192_relat TO p_nom_arquivo
   END IF
...
#--------------------------------#
 FUNCTION pol1192_le_den_empresa()
#--------------------------------#
...
#----------------------#
   ...
   FORMAT
      ...
      FIRST PAGE HEADER
         ...
         PRINT COLUMN 001, "pol1192    PORCENTAGEM P/ APLICACAO NO FATURAMENTO",
