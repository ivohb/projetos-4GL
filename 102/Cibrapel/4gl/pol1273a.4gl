...
# - O Trim enviará bobinas a serem destruidas. Nesse caso, o pol1273a#
...
#   pol1273a deverá fazer uma saída do item por uma operação de suca-#
#   teamento.                                                       #
#-------------------------------------------------------------------#
...
MAIN
   ...
   CALL LOG_connectDatabase("DEFAULT")
      ...
      LET p_status = 0
      LET p_user = 'admlog'
      LET m_processo = 'Agend Tatefa Windows'
      CALL pol1273a_processar() RETURNING p_status
      CALL pol1273a_e_mail()   
   
END MAIN       

#------------------------#
FUNCTION pol1273a_e_mail()#
#------------------------#
   ...
   IF m_qtd_erro > 0 THEN
      CALL pol1273a_envia_email()
   END IF

END FUNCTION

#------------------------------#
FUNCTION pol1270_exec_pol1273a()#
#------------------------------#
   ...
   LET l_comando = p_caminho CLIPPED, 'pol1273a.bat ', p_cod_empresa
...
#--------------------------------#
 FUNCTION pol1273a_verifica_erros()
#--------------------------------#
...
#------------------------------#
FUNCTION pol1273a_ins_processo()#
#------------------------------#
...
#---------------------------#
 FUNCTION pol1273a_processar()
#---------------------------#

   LET p_versao = 'pol1273A-10.02.21 '  
   ...
   IF NOT log0150_verifica_se_tabela_existe("proces_cons_885") THEN
      IF NOT pol1273a_cria_tabela() THEN
         RETURN 
      END IF
   END IF
   
   LET p_msg = 'INICIO do processamento'
   CALL pol1273a_ins_processo()
   CALL pol1273a_exec_proces() RETURNING p_status
...
#-----------------------------#
   ...
   IF NOT pol1273a_le_parametros() THEN
      RETURN FALSE
   END IF
   ...
   IF NOT pol1273a_elimina_estornos() THEN
      RETURN FALSE
   END IF
   
   IF NOT pol1273a_importa_consumo() THEN
      RETURN FALSE
   END IF

   IF NOT pol1273a_importa_refugo() THEN
      RETURN FALSE
   END IF
...
#----------------------------------#
FUNCTION pol1273a_elimina_estornos()
#----------------------------------#
...
#------------------------------#
FUNCTION pol1273a_le_parametros()
#------------------------------#
...
#--------------------------------#
FUNCTION pol1273a_importa_consumo()
#--------------------------------#
   ...
   FOREACH cq_baixa INTO 
      ...
      #IF NOT pol1273a_apaga_erros() THEN
      #   RETURN FALSE
      #END IF
      ...
      IF NOT pol1273a_consiste_info() THEN
         CALL log085_transacao("ROLLBACK")  
         RETURN FALSE
      END IF
      ...
      IF p_criticou THEN
      ELSE
         IF NOT pol1273a_proces_consumo() THEN
            CALL log085_transacao("ROLLBACK")  
            RETURN FALSE
         ELSE
      ...
      IF NOT pol1273a_grava_cons_trim() THEN
         CALL log085_transacao("ROLLBACK")  
         RETURN FALSE
      END IF
...
#---------------------------------#
FUNCTION pol1273a_grava_cons_trim()
#---------------------------------#
...
#-------------------------------#
FUNCTION pol1273a_consiste_info()
#-------------------------------#
   ...
   IF p_consu.dat_consumo IS NOT NULL THEN
      ...
      IF p_dat_fecha_ult_man IS NOT NULL THEN
         IF p_dat_movto <= p_dat_fecha_ult_man THEN
            ...
            IF NOT pol1273a_grava_erro() THEN
               RETURN FALSE
            END IF
         END IF
       END IF      
   ...
   IF p_consu.cod_item IS NULL OR p_consu.cod_item = 0 THEN
      ...
      END IF
   ELSE
      IF NOT pol1273a_checa_item(p_consu.cod_item) THEN
         RETURN FALSE
      END IF
   END IF

   IF NOT pol1273a_le_item_man(p_consu.cod_item) THEN
      RETURN FALSE
   END IF
   ...
   IF p_consu.cod_itemrefugo IS NOT NULL THEN
      IF p_ies_apara = 'S' THEN
         IF NOT pol1273a_checa_item(p_consu.cod_itemrefugo) THEN
            RETURN FALSE
         END IF
      ...
      END IF
   ELSE
      IF NOT pol1273a_checa_item(p_parametros_885.cod_item_refugo) THEN
         RETURN FALSE
      END IF
...
#--------------------------------------#
FUNCTION pol1273a_checa_item(p_cod_item)
#--------------------------------------#
...
#-----------------------------------#
FUNCTION pol1273a_le_item_man(p_item)
#-----------------------------------#
...
#-------------------------------#
FUNCTION pol1273a_proces_consumo()
#-------------------------------#
            
   IF p_consu.cod_estorno = 0 THEN
      IF NOT pol1273a_baixa_consumo() THEN
         RETURN FALSE
      END IF
   ELSE
      IF NOT pol1273a_estorna_conusmo() THEN
         RETURN FALSE
      END IF
   END IF  
...
#------------------------------#
FUNCTION pol1273a_baixa_consumo()
#------------------------------#
   ...
   IF NOT pol1273a_gra_relac() THEN
      RETURN FALSE
   END IF
   ...
   IF NOT pol1273a_efetua_baixa() THEN
      RETURN FALSE
   END IF
...
#-------------------------------#
FUNCTION pol1273a_le_lote_ender()
#-------------------------------#
...
#------------------------------#
FUNCTION pol1273a_efetua_baixa()#
#------------------------------#   
   ...
   IF NOT pol1273a_ins_transacoes() THEN
      RETURN FALSE
   END IF
...
#-------------------------------#
FUNCTION pol1273a_ins_transacoes()
#-------------------------------#
...
#----------------------------------#
FUNCTION pol1273a_bx_do_alternativo()
#----------------------------------#
...
#--------------------------------#
FUNCTION pol1273a_estorna_conusmo()
#--------------------------------#
   ...
   FOREACH cq_trans_s INTO p_num_transac
      ...
      IF NOT pol1273a_estorna_estoq() THEN
         RETURN FALSE
      END IF
...
#--------------------------------#
FUNCTION pol1273a_estorna_estoq()#
#--------------------------------#
...
#-------------------------------#
FUNCTION pol1273a_importa_refugo()
#-------------------------------#
   ...
   FOREACH cq_baixa INTO 
      ...
      IF p_criticou THEN
      ELSE
         IF NOT pol1273a_proces_refugo() THEN
            CALL log085_transacao("ROLLBACK")  
            RETURN FALSE
         ELSE
            IF NOT p_criticou THEN
...
#------------------------------#
FUNCTION pol1273a_proces_refugo()
#------------------------------#
            
   IF p_consu.cod_estorno = 0 THEN
      IF NOT pol1273a_baixa_refugo() THEN
         RETURN FALSE
      END IF
   ELSE
      IF NOT pol1273a_estorna_refugo() THEN
         RETURN FALSE
      END IF
   END IF  
...
#-----------------------------#
FUNCTION pol1273a_baixa_refugo()
#-----------------------------#

   {IF NOT pol1273a_le_oper_orig() THEN
      RETURN FALSE
   END IF}
   ...
   {IF NOT pol1273a_le_oper_dest() THEN
      RETURN FALSE
   END IF}
   ...
   IF NOT pol1273a_grava_destino() THEN
      RETURN FALSE
   END IF
   ...
   IF NOT pol1273a_ins_est_trans_relac() THEN
      RETURN FALSE
   END IF
...
#-------------------------------------#
FUNCTION pol1273a_ins_est_trans_relac()#
#-------------------------------------#
...
#------------------------------#
FUNCTION pol1273a_le_oper_orig()
#------------------------------#
...
#------------------------------#
FUNCTION pol1273a_le_oper_dest()
#------------------------------#
...
#-------------------------------#
FUNCTION pol1273a_grava_destino()#
#-------------------------------#   
...
#--------------------------------#
FUNCTION pol1273a_estorna_refugo()
#--------------------------------#
...
#-------------------------------#
FUNCTION pol1273a_lst_confronto()#
#-------------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol1273ac") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol1273ac AT 6,4 WITH FORM p_nom_tela
      ATTRIBUTE(BORDER, MESSAGE LINE LAST, PROMPT LINE LAST, FORM LINE FIRST)

   CALL pol1273a_lista_baixas() RETURNING p_status
   
   CLOSE WINDOW w_pol1273ac
...
#------------------------------#
FUNCTION pol1273a_lista_baixas()#
#------------------------------#
   ...
   IF NOT pol1273a_le_den_empresa() THEN
      RETURN FALSE
   END IF

   IF p_tela.listar = 'I' THEN
      IF NOT pol1273a_agrupa_item() THEN
         RETURN FALSE
      END IF      
   ELSE
      IF NOT pol1273a_detalhado() THEN
         RETURN FALSE
      END IF      
   END IF
...
#-----------------------------#
FUNCTION pol1273a_agrupa_item()#
#-----------------------------#

   IF NOT pol1273a_inicializa_relat() THEN
      RETURN FALSE
   END IF
   ...
   FOREACH cq_confronto INTO p_relat.*   
      ...
      OUTPUT TO REPORT pol1273a_relat(p_relat.cod_item) 
      
      LET p_count = 1
      
    END FOREACH

   CALL pol1273a_finaliza_relat()
...
#--------------------------------#
 FUNCTION pol1273a_le_den_empresa()
#--------------------------------#
...
#----------------------------------#
FUNCTION pol1273a_inicializa_relat()#
#----------------------------------#
   ...
   IF p_ies_impressao = "S" THEN 
      IF g_ies_ambiente = "U" THEN
         START REPORT pol1273a_relat TO PIPE p_nom_arquivo
      ELSE 
         CALL log150_procura_caminho ('LST') RETURNING p_caminho
         LET p_caminho = p_caminho CLIPPED, 'pol1273a.tmp' 
         START REPORT pol1273a_relat TO p_caminho 
      END IF 
   ELSE
      START REPORT pol1273a_relat TO p_nom_arquivo
   END IF
...
#--------------------------------#
FUNCTION pol1273a_finaliza_relat()
#--------------------------------#

   FINISH REPORT pol1273a_relat
...
#--------------------------------#
 REPORT pol1273a_relat(l_cod_item)#
#--------------------------------#
...
#---------------------------#
FUNCTION pol1273a_detalhado()#
#---------------------------#

   IF NOT pol1273a_start_relat() THEN
      RETURN FALSE
   END IF
   ...
   FOREACH cq_ordem INTO p_detal.*   
      ...
      OUTPUT TO REPORT pol1273a_detal(p_detal.cod_item) 
      
      LET p_count = 1
      
    END FOREACH

   CALL pol1273a_stop_relat()
   CALL log0030_mensagem(p_msg, 'excla')
...
#-----------------------------#
   ...
   IF p_ies_impressao = "S" THEN 
      IF g_ies_ambiente = "U" THEN
         START REPORT pol1273a_detal TO PIPE p_nom_arquivo
      ELSE 
         CALL log150_procura_caminho ('LST') RETURNING p_caminho
         LET p_caminho = p_caminho CLIPPED, 'pol1273a.tmp' 
         START REPORT pol1273a_detal TO p_caminho 
      END IF 
   ELSE
      START REPORT pol1273a_detal TO p_nom_arquivo
   END IF
...
#----------------------------#
FUNCTION pol1273a_stop_relat()#
#----------------------------#

   FINISH REPORT pol1273a_detal
...
#--------------------------------#
 REPORT pol1273a_detal(l_cod_item)#
#--------------------------------#
...
#-----------------------------#
   ...
   LET p_arquivo = 'pol1273a.lst'
   LET p_den_comando = p_caminho CLIPPED, p_arquivo CLIPPED
         
   START REPORT pol1273a_email TO p_den_comando
     
   OUTPUT TO REPORT pol1273a_email() 
      
   FINISH REPORT pol1273a_email  
