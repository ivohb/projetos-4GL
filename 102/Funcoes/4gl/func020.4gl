...
#------------------------------------#
FUNCTION func020_par_fiscal(lr_param)#
#------------------------------------#
   ...
   IF NOT func020_cria_tabelas() THEN
      RETURN m_msg
   END IF

   IF NOT func020_le_param_fisc() THEN
      RETURN m_msg
   END IF
...
#------------------------------#
FUNCTION func020_le_param_fisc()
#------------------------------#
   
   IF NOT func020_le_item()  THEN 
      RETURN FALSE	
   END IF 
   ...
   FOREACH  cq_tributos INTO p_tributo_benef
      ...
      FOREACH cq_acesso INTO p_seq_acesso
         ...
         CALL func020_pega_chave()

	       IF NOT func020_checa_tributo()  THEN 
	          RETURN FALSE	
         END IF 
...
#-------------------------------#
FUNCTION func020_checa_tributo()
#-------------------------------#
   ...
   FOREACH cq_chave INTO p_chave
      ...
      WHEN 'REGIAO' 
         IF NOT func020_le_obf_regiao() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_CLASSIF' 
         IF NOT func020_le_obf_cl_fisc() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_ITEM' 
         IF NOT func020_le_obf_fisc_item() THEN
            RETURN FALSE
         END IF
      ...
      WHEN 'GRP_CLIENTE' 
         IF NOT func020_le_obf_fisc_cli() THEN
            RETURN FALSE
         END IF
...
#-------------------------------#
FUNCTION func020_le_obf_regiao()
#-------------------------------#
...
#-------------------------------#
FUNCTION func020_le_obf_cl_fisc()
#-------------------------------#
...
#---------------------------------#
FUNCTION func020_le_obf_fisc_item()
#---------------------------------#
...
#---------------------------------#
FUNCTION func020_le_obf_fisc_cli()
#---------------------------------#
