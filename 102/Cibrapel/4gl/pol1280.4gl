...
#----------------------#
    ...
    CALL _ADVPL_set_property(l_inform,"EVENT","pol1280_informar")
    CALL _ADVPL_set_property(l_inform,"CONFIRM_EVENT","pol1280_confirmar")
    CALL _ADVPL_set_property(l_inform,"CANCEL_EVENT","pol1280_cancelar")

       #Criação do botão processar
    LET l_print = _ADVPL_create_component(NULL,"LPROCESSBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_print,"EVENT","pol1280_processar")
    ...
    CALL pol1280_cria_campos(l_panel)

    CALL pol1280_ativa_desativa(FALSE)
...
#----------------------------------------#
FUNCTION pol1280_cria_campos(l_container)#
#----------------------------------------#
    ...
    CALL _ADVPL_set_property(m_empresa,"VALID","pol1280_checa_empresa")
    ...
    CALL _ADVPL_set_property(m_lupa_empresa,"CLICK_EVENT","pol1280_zoom_empresa")
    ...
    CALL _ADVPL_set_property(m_portador,"VALID","pol1280_checa_portador")
    ...
    CALL _ADVPL_set_property(m_lupa_portador,"CLICK_EVENT","pol1280_zoom_portador")
    ...
    CALL _ADVPL_set_property(m_cliente,"VALID","pol1280_checa_cliente")
    ...
    CALL _ADVPL_set_property(m_lupa_cliente,"CLICK_EVENT","pol1280_zoom_cliente")
    ...
    CALL _ADVPL_set_property(m_docum,"VALID","pol1280_checa_docum")
...
#----------------------------------------#
FUNCTION pol1280_ativa_desativa(l_status)#
#----------------------------------------#
...
#--------------------------#
FUNCTION pol1280_informar()#
#--------------------------#

   CALL pol1280_ativa_desativa(TRUE)
   CALL pol1280_limpa_campos()
...
#-------------------------------#
FUNCTION pol1280_checa_empresa()#
#-------------------------------#
...
#--------------------------------#
FUNCTION pol1280_checa_portador()#
#--------------------------------#
...
#-------------------------------#
FUNCTION pol1280_zoom_portador()#
#-------------------------------#
...
#-------------------------------#
FUNCTION pol1280_checa_cliente()#
#-------------------------------#
...
#---------------------------#
   ...
   CALL LOG_progresspopup_start("Recalculando juros","pol1280_recalcular","PROCESS")
...
#----------------------------#
FUNCTION pol1280_recalcular()#
#----------------------------#
   
   LET p_status = pol1280_le_titulos()
...
#-------------------------#
   ...
   FOREACH cq_pgto INTO       
      ...
      IF mr_docum.dat_pgto <= m_data_base THEN
         LET m_val_juros = 0
      ELSE      
         IF NOT pol1280_cal_dia_mes() THEN
            RETURN FALSE
         END IF
   ...
   IF NOT pol1280_atu_docum() THEN
      RETURN FALSE
   END IF
   
   IF NOT pol1280_ins_obs() THEN
      RETURN FALSE
   END IF
...
#-------------------------#
   ...
   LET l_docum_obs.tex_obs_3 = 'PELO LOGIN DO ', p_user CLIPPED, ' NO POL1280'
