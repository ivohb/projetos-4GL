...
GLOBALS
   DEFINE p_cod_empresa        LIKE empresa.cod_empresa,
          ...
          p_qtd_consumida      LIKE ordem_montag_tran.qtd_devolvida,
          p_qtd_neces          LIKE ordem_montag_tran.qtd_devolvida,
          p_qtd_om             LIKE ordem_montag_tran.qtd_devolvida,
          p_qtd_dev_ldi        LIKE ordem_montag_tran.qtd_devolvida,
          p_qtd_dev_fat        LIKE ordem_montag_tran.qtd_devolvida,
...
## DESATIVADO EM 11-03-2015 Manuel    INSERT INTO ordem_montag_tran VALUES (p_ordem_montag_tran.*)
## DESATIVADO EM 11-03-2015 Manuel    
## DESATIVADO EM 11-03-2015 Manuel    IF SQLCA.SQLCODE <> 0 THEN 
## DESATIVADO EM 11-03-2015 Manuel       LET p_houve_erro = TRUE
## DESATIVADO EM 11-03-2015 Manuel 	    CALL log003_err_sql("INCLUSAO","ORDEM_MONTAG_TRAN")
## DESATIVADO EM 11-03-2015 Manuel       RETURN FALSE
## DESATIVADO EM 11-03-2015 Manuel    END IF
   
## DESATIVADO EM 11-03-2015 Manuel    LET p_num_trans = SQLCA.SQLERRD[2]
   
## DESATIVADO EM 11-03-2015 Manuel    INSERT INTO ldi_om_trfor_inf_c 
## DESATIVADO EM 11-03-2015 Manuel       VALUES (p_ordem_montag_tran.cod_empresa,p_num_trans,p_cod_fornecedor)

## DESATIVADO EM 11-03-2015 Manuel    IF SQLCA.SQLCODE <> 0 THEN 
## DESATIVADO EM 11-03-2015 Manuel       LET p_houve_erro = TRUE
## DESATIVADO EM 11-03-2015 Manuel 	    CALL log003_err_sql("INCLUSAO","LDI_OM_TRFOR_INF_C")
## DESATIVADO EM 11-03-2015 Manuel       RETURN FALSE
## DESATIVADO EM 11-03-2015 Manuel    END IF
   ...
   INSERT INTO ldi_retn_terc_grd 
     VALUES(p_cod_empresa,
            ...
            p_ordem_montag_item.num_sequencia,
            0,0,0,0,0,
	          p_item_de_terc.num_nf,
	          p_item_de_terc.ser_nf,
	          p_item_de_terc.ssr_nf,
...
#--------------------------------#
   ...
   LET sql_stmt = "SELECT UNIQUE empresa, ",
                  "              ord_montag, ",
                  "              seq_item_pedido ",
...
#-----------------------------#
   ...
   SELECT cod_item, nf_entrada, qtd_devolvida, preco_unit 
    FROM ldi_retn_terc_grd, nf_sup, aviso_rec
   WHERE ldi_retn_terc_grd.empresa = nf_sup.cod_empresa
     AND ldi_retn_terc_grd.nf_entrada = nf_sup.num_nf
     AND ldi_retn_terc_grd.serie_nf_entrada = nf_sup.ser_nf
     AND ldi_retn_terc_grd.subserie_nfe = nf_sup.ssr_nf
     AND ldi_retn_terc_grd.fornecedor = nf_sup.cod_fornecedor
     AND aviso_rec.cod_empresa = nf_sup.cod_empresa
     AND aviso_rec.num_aviso_rec = nf_sup.num_aviso_rec
     AND aviso_rec.num_seq = ldi_retn_terc_grd.seq_aviso_recebto
     AND ldi_retn_terc_grd.empresa = p_ordem_montag_tran.cod_empresa
     AND ldi_retn_terc_grd.ord_montag = p_ordem_montag_tran.num_om
     AND ldi_retn_terc_grd.seq_item_pedido = p_ordem_montag_tran.num_seq_item
     ORDER BY 1
