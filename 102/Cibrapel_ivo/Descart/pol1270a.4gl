...
#----------------------------------#
   ...
   IF p_man.tip_movto = 'F' THEN          #apontamento de boas
      LET p_qtd_boas = p_man.qtd_movto
      LET p_tip_producao = "B"                               
      LET p_ies_situa = 'L'                                  
   END IF

   IF p_man.tip_movto = 'E' THEN          #apontamento de boas
      LET p_qtd_boas = p_man.qtd_movto
      LET p_tip_producao = "B"                               
      LET p_ies_situa = 'E'                                  
   END IF
...
#--------------------------------#
   ...
   IF NOT pol1270_ins_transacoes() THEN
      RETURN FALSE
   END IF
...
#--------------------------------#
FUNCTION pol1270_ins_transacoes()#
#--------------------------------#
...
#----------------------------------------#
   ...
   LET p_man_item_produzido.moviment_estoque      = p_transac_apont
...
#-------------------------------------#
   ...
   LET p_man_comp_consumido.mov_estoque_pai    = p_transac_apont
...
#-----------------------------------#      
   ...
   #estorna as saidas (baixa de material e saida de refugo)
...
#--------------------------------#
   ...
   DEFINE  p_cod_compon      LIKE ord_compon.cod_item_compon,
           p_qtd_baixar      LIKE necessidades.qtd_saida
...
#-------------------------------#
FUNCTION pol1270a_trans_refugo()#
#-------------------------------#
