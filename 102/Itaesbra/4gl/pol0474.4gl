...
# PROGRAMA: pol0474                                                 #
# MODULOS.: pol0474-LOG0010-LOG0030-LOG0040-LOG0050-LOG0060         #
...
MAIN
   ...
   DEFER INTERRUPT
   LET p_versao = "pol0474-10.02.00"
   INITIALIZE p_nom_help TO NULL  
   CALL log140_procura_caminho("pol0474.iem") RETURNING p_nom_help
...
#   CALL log001_acessa_usuario("VDP")
   ...
   IF p_status = 0  THEN
      CALL pol0474_controle()
   END IF
END MAIN

#--------------------------#
 FUNCTION pol0474_controle()
#--------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol0474") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol0474 AT 2,2 WITH FORM p_nom_tela
   ...
   MENU "OPCAO"
      COMMAND "Incluir" "Inclui Dados na Tabela"
         ...
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol0474_modificar() RETURNING p_status
         IF p_status THEN
      ...
      COMMAND "Fim"       "Retorna ao Menu Anterior"
         ...
         EXIT MENU
   END MENU
   CLOSE WINDOW w_pol0474

END FUNCTION

#--------------------------#
FUNCTION pol0474_modificar()
#--------------------------#

   IF NOT p_ies_cons THEN
      CALL pol0474_exibe_simbolos()
   END IF
   IF pol0474_aceita_simbolos() THEN
      CALL pol0474_grava_simbolos()
   ELSE
      CALL pol0474_exibe_simbolos()
   END IF
...
#--------------------------------#
FUNCTION pol0474_aceita_simbolos()
#--------------------------------#
...
#--------------------------------#
FUNCTION pol0474_grava_simbolos()
#--------------------------------#
...
#--------------------------------#
 FUNCTION pol0474_exibe_simbolos()
#--------------------------------#
...
#-----------------------------------#
 FUNCTION pol0474_emite_relatorio()
#-----------------------------------#
   ...
   FOREACH cq_imp INTO p_simbolo_itaesbra.*
      ...
      OUTPUT TO REPORT pol0474_relat() 
