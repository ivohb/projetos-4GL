...
{ TABLE "informix".fat_nf_item row size = 393 number of columns = 44 index size = 
              52 }
...
create index "informix".int5_fat_nf_item on "informix".fat_nf_item 
    (empresa,trans_nota_fiscal,item) using btree ;
