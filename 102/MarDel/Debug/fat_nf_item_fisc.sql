...
{ TABLE "informix".fat_nf_item_fisc row size = 277 number of columns = 49 index size 
              = 46 }
create table "informix".fat_nf_item_fisc 
  (
    ...
    qtd_base_calc decimal(11,6),
    codigo_debito decimal(2,0),
    codigo_ajuste char(10),
    natureza_deducao char(1),
    modbcst decimal(2,0),
    primary key (empresa,trans_nota_fiscal,seq_item_nf,tributo_benef)  constraint 
              "informix".pk_fat_nf_item_fisc
  );

revoke all on "informix".fat_nf_item_fisc from "public" as "informix";


create index "informix".ix1_fat_nf_item_fisc on "informix".fat_nf_item_fisc 
    (empresa,trans_config) using btree ;
