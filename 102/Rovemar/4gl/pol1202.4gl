...
DATABASE LOGIX102
   ...
   DEFINE P_ITEM_PPAP_1120  RECORD 
    COD_EMPRESA   CHAR(2),
    COD_ITEM      CHAR(15),
    COD_REVISAO   CHAR(2),
    DAT_REVISAO   DATE,
   ...
   DEFINE P_ITEM_PPAP_1120A RECORD
    COD_EMPRESA   CHAR(2),
    COD_ITEM      CHAR(15),
    COD_REVISAO   CHAR(2),
    DAT_REVISAO   DATE,
...
MAIN
   ...
   DEFER INTERRUPT
   LET P_VERSAO = "pol1202-10.02.01"
   INITIALIZE P_NOM_HELP TO NULL  
   CALL LOG140_PROCURA_CAMINHO("pol1202.IEM") RETURNING P_NOM_HELP
   ...
   IF P_STATUS = 0  THEN
      CALL pol1202_CONTROLE()
   END IF
END MAIN

#--------------------------#
 FUNCTION pol1202_CONTROLE()
#--------------------------#

   CALL LOG006_EXIBE_TECLAS("01",P_VERSAO)
   INITIALIZE P_NOM_TELA TO NULL 
   CALL LOG130_PROCURA_CAMINHO("pol1202") RETURNING P_NOM_TELA
   LET P_NOM_TELA = P_NOM_TELA CLIPPED 
   OPEN WINDOW W_pol1202 AT 2,2 WITH FORM P_NOM_TELA
      ATTRIBUTE(BORDER, MESSAGE LINE LAST, PROMPT LINE LAST)
   DISPLAY P_COD_EMPRESA TO COD_EMPRESA
   
   LET P_COD_FILIAL = '0101'
   
   CALL pol1202_CARREGA_LETRA()
   ...
   MENU "OPCAO"
      COMMAND "INCLUIR" "INCLUI DADOS NAS TABELAS"
         ...
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1202_INCLUIR() RETURNING P_STATUS
         IF P_STATUS THEN
      ...
      COMMAND "SEGUINTE" "EXIBE O PROXIMO ITEM ENCONTRADO NA CONSULTA"
         ...
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1202_PAGINACAO("SEGUINTE")
      COMMAND "ANTERIOR" "EXIBE O ITEM ANTERIOR ENCONTRADO NA CONSULTA"
         HELP 006
         MESSAGE ""
         LET INT_FLAG = 0
         CALL pol1202_PAGINACAO("ANTERIOR")
      ...
      COMMAND "FIM"       "RETORNA AO MENU ANTERIOR"
         ...
         EXIT MENU
   END MENU
   CLOSE WINDOW W_pol1202

END FUNCTION

#------------------------------#
FUNCTION pol1202_CARREGA_LETRA()
#------------------------------#
...
#-----------------------#
FUNCTION pol1202_INCLUIR()
#-----------------------#

   LET P_RETORNO = FALSE
   
   IF pol1202_ACEITA_CHAVE() THEN 
      IF pol1202_CARREGA_COMPON() THEN
         IF pol1202_ACEITA_OPERACAO() THEN
            IF pol1202_GRAVA_ITENS() THEN
               LET P_RETORNO = TRUE
            END IF
         END IF
      END IF
...
#-----------------------------#
FUNCTION pol1202_ACEITA_CHAVE()
#-----------------------------#

   CALL LOG006_EXIBE_TECLAS("01 02 07",P_VERSAO)
   CURRENT WINDOW IS W_pol1202
   CLEAR FORM
   DISPLAY P_COD_EMPRESA TO COD_EMPRESA
...
#-----------------------#
   ...
   CASE
      ...
      WHEN INFIELD(COD_SIMBOLO)
         CALL LOG009_POPUP(8,25,"SIMBOLOS","SIMBOLO_1120",
...
#-------------------------------#
FUNCTION pol1202_CARREGA_COMPON()
#-------------------------------#

   IF NOT pol1202_CRIA_TEMPS() THEN
      RETURN FALSE
   END IF
...
#--------------------------------#
FUNCTION pol1202_ACEITA_OPERACAO()
#--------------------------------#
...
#-----------------------------#
FUNCTION pol1202_DELETA_ITEM()
#-----------------------------#

   DELETE FROM COMPON_PPAP_1120
    WHERE COD_EMPRESA = P_COD_EMPRESA
      AND COD_ITEM    = P_TELA.COD_ITEM

   IF SQLCA.SQLCODE <> 0 THEN 
      CALL LOG003_ERR_SQL("DELETANDO","COMPON_PPAP_1120")    
      RETURN FALSE
   END IF

   DELETE FROM ITEM_PPAP_1120
    WHERE COD_EMPRESA = P_COD_EMPRESA
      AND COD_ITEM    = P_TELA.COD_ITEM
   
   IF SQLCA.SQLCODE <> 0 THEN 
      CALL LOG003_ERR_SQL("DELETANDO","ITEM_PPAP_1120")    
      RETURN FALSE
   END IF
...
#-----------------------------#
   ...
   IF P_JA_EXPORTOU THEN
      IF NOT pol1202_DELETA_ITEM() THEN
         CALL LOG085_TRANSACAO("ROLLBACK") 
         RETURN FALSE
      END IF
   END IF

   IF NOT pol1202_INS_PROTHEUS() THEN
      CALL LOG085_TRANSACAO("ROLLBACK") 
      RETURN FALSE
   END IF

   INSERT INTO ITEM_PPAP_1120
   ...
   IF SQLCA.SQLCODE <> 0 THEN 
      CALL LOG003_ERR_SQL("INCLUSAO","ITEM_PPAP_1120")    
      CALL LOG085_TRANSACAO("ROLLBACK") 
      RETURN FALSE
   END IF
...
#------------------------------#
   ...
   FOR P_IND = 1 TO ARR_COUNT()
       ...
       IF SQLCA.SQLCODE <> 0 THEN 
          CALL LOG003_ERR_SQL("INCLUSAO","COMPON_PPAP_1120")    
          CALL LOG085_TRANSACAO("ROLLBACK") 
          RETURN FALSE
       END IF
       ...
       LET P_QKK010.QKK_ITEM     = pol1202_FORMATA(P_IND)
           
       IF NOT pol1202_INS_QKK010() THEN
          RETURN FALSE
       END IF
...
#-------------------------------#
FUNCTION pol1202_FORMATA(P_ITEM)
#-------------------------------#
...
#--------------------------#
 FUNCTION pol1202_CONSULTA()
#--------------------------#
   
   CLEAR FORM
   DISPLAY P_COD_EMPRESA TO COD_EMPRESA
   LET P_ITEM_PPAP_1120A.* = P_ITEM_PPAP_1120.*
   
   CONSTRUCT BY NAME WHERE_CLAUSE ON 
      ITEM_PPAP_1120.COD_ITEM,
      ITEM_PPAP_1120.COD_REVISAO,
      ITEM_PPAP_1120.DAT_REVISAO,
      ITEM_PPAP_1120.COD_PECA_PPAP

      ON KEY (CONTROL-Z)
         CALL LOG009_POPUP(8,25,"ITENS","ITEM_PPAP_1120",
                     "COD_ITEM","","","S","") 
            RETURNING P_ITEM_PPAP_1120.COD_ITEM
         CALL LOG006_EXIBE_TECLAS("01 02 03 07", P_VERSAO)
         CURRENT WINDOW IS W_pol1202
         IF P_ITEM_PPAP_1120.COD_ITEM IS NOT NULL THEN
            DISPLAY P_ITEM_PPAP_1120.COD_ITEM TO COD_ITEM
         END IF
   ...
   IF INT_FLAG <> 0 THEN
      LET INT_FLAG = 0 
      LET P_ITEM_PPAP_1120.* = P_ITEM_PPAP_1120A.*
      CALL pol1202_EXIBE_DADOS()
      ERROR "CONSULTA CANCELADA"
      RETURN
   END IF

   LET SQL_STMT = "SELECT * FROM ITEM_PPAP_1120 ",
   ...
   OPEN CQ_CONSULTA
   FETCH CQ_CONSULTA INTO P_ITEM_PPAP_1120.*
...
#-----------------------------------#
   ...
   SELECT DEN_ITEM_REDUZ
     ...
     FROM ITEM
    WHERE COD_EMPRESA = P_COD_EMPRESA
      AND COD_ITEM    = P_ITEM_PPAP_1120.COD_ITEM
  
   DISPLAY P_COD_EMPRESA TO COD_EMPRESA
   DISPLAY P_ITEM_PPAP_1120.COD_ITEM TO COD_ITEM
   DISPLAY P_DEN_ITEM TO DEN_ITEM
   DISPLAY P_ITEM_PPAP_1120.COD_REVISAO   TO COD_REVISAO
   DISPLAY P_ITEM_PPAP_1120.DAT_REVISAO   TO DAT_REVISAO
   DISPLAY P_ITEM_PPAP_1120.COD_PECA_PPAP TO COD_PECA_PPAP
 
   CALL pol1202_EXIBE_COMPON()
   
 END FUNCTION

#------------------------------#
 FUNCTION pol1202_EXIBE_COMPON()
#------------------------------#
...
#-----------------------------------#
 FUNCTION pol1202_PAGINACAO(P_FUNCAO)
#-----------------------------------#
