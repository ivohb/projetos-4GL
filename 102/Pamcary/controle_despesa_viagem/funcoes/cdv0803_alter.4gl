...
#--------------------------------------#
   ...
   DECLARE cq_unifun CURSOR FOR
    SELECT cod_uni_funcio
     ...
     WHERE cod_empresa = p_cod_empresa
       AND cod_usuario = l_cod_usuario #p_user1
...
#-------------------------------#
  RETURN "$Archive: /Logix/Fontes_Doc/Customizacao/10R2/gps_logist_e_gerenc_de_riscos_ltda/financeiro/controle_despesa_viagem/funcoes/cdv0803.4gl $|$Revision: 7 $|$Date: 23/12/11 12:22 $|$Modtime:  $" #Informações do controle de versão do SourceSafe - Não remover esta linha (FRAMEWORK)
 END FUNCTION