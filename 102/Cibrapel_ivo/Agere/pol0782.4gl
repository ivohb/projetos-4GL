...
# PROGRAMA: pol0782                                                     #
# MODULOS.: pol0782 - LOG0010 - LOG0030 - LOG0040 - LOG0050             #
#           LOG0060 - LOG0090 - LOG0190 - LOG0270 - LOG1200             #
#           LOG1300 - LOG1400 - VDP0050 - VDP0120 - VDP0140             #
# OBJETIVO: COMPATIBILIZA REQUISICOES DE ESTOQUE                        #
...
GLOBALS
   ...
   DEFINE lr_wpol0782           RECORD LIKE wpol0782.*,
...
MAIN
  ...
  CALL log001_acessa_usuario("SUPRIMEN","LIC_LIB")
   ...
   IF p_status = 0 THEN 
      CALL pol0782_controle()
   END IF

END MAIN

#--------------------------#
 FUNCTION pol0782_controle()
#--------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol0782") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol0782 AT 06,23 WITH FORM p_nom_tela
   ...
   IF pol0782_acerta_entradas() THEN
...
#---------------------------------#
 FUNCTION pol0782_acerta_entradas()
#---------------------------------#
  ...
  {Primeiro copia pedidos para a OF quando quando viram pedido na GR, depois atualiza os pedidos recebidos na OF} 
   ...
   INITIALIZE l_ordem_sup.*,l_prog_ordem_sup.*, l_dest_ordem_sup.*, l_estrut_ordem_sup.*, 
              ...
              l_pedido_sup.*, l_pedido_sup_txt.*, l_ordem_sup_audit.*, lr_wpol0782.* TO NULL

   FOREACH cq_entrada INTO lr_wpol0782.*
   
          INITIALIZE p_cod_empresa_copia TO NULL
   
         IF lr_wpol0782.cod_empresa = l_empresas_885.cod_emp_gerencial THEN
            LET p_cod_empresa_copia  = l_empresas_885.cod_emp_oficial
            IF lr_wpol0782.indicador = 'I' THEN
               IF pol0782_ordem_aberta() = FALSE THEN
               ELSE
                  IF pol0782_copia_oc() = FALSE THEN
                     RETURN  FALSE
                  END IF
               END IF
            ELSE
               IF lr_wpol0782.indicador = 'E' THEN   
                  IF pol0782_verifica_exclusao() = FALSE THEN
                  ELSE
                     IF pol0782_deleta_oc() = FALSE THEN
                        RETURN  FALSE
                     END IF  
                  END IF  
               END IF                             
            END IF  
         ELSE  
             IF lr_wpol0782.cod_empresa = l_empresas_885.cod_emp_oficial THEN
         ...
         IF NOT pol0782_deleta_wpol0782() THEN
            RETURN  FALSE
         END IF
...
#-------------------------------#
   ...
   ELSE 
      IF sqlca.sqlcode <> 0 THEN
        ...
        #CALL log003_err_sql("DELETE","Wpol0782")       
         RETURN FALSE
       END IF
   END IF
...
#-----------------------------------#
 FUNCTION pol0782_verifica_exclusao()
#----------------------------------#
      ...
      SELECT COUNT(*) 
        INTO p_tem_oc
        FROM ordem_sup
       WHERE cod_empresa 		= lr_wpol0782.cod_empresa
         AND num_oc      		= lr_wpol0782.num_oc
...
#-------------------------------#
 FUNCTION pol0782_deleta_oc()
#-------------------------------#

      IF pol0782_elimina_oc() = FALSE THEN 
         RETURN FALSE
      END IF 
 
      IF pol0782_elimina_prog() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_elimina_prog_com() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_elimina_dest() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_elimina_estr() = FALSE THEN
         RETURN FALSE
      END IF 
   
      IF pol0782_elimina_txt() = FALSE THEN
         RETURN FALSE
      END IF 
      
      IF pol0782_elimina_compl() = FALSE THEN
         RETURN FALSE
      END IF 
      
      IF lr_wpol0782.cod_empresa = l_empresas_885.cod_emp_oficial  THEN
         IF pol0782_elimina_ped_ger() = FALSE THEN
             RETURN FALSE
         END IF 
         IF pol0782_elimina_txt_ped_ger() = FALSE THEN
             RETURN FALSE
         END IF 
      END IF 
...
END FUNCTION      
#----------------------------------#
 FUNCTION pol0782_elimina_prog_com()
#----------------------------------#
...
END FUNCTION   
#----------------------------------#
 FUNCTION pol0782_elimina_compl()
#----------------------------------#
...
#----------------------------------#
 FUNCTION pol0782_elimina_ped_ger()
#----------------------------------#
...
END FUNCTION  
#----------------------------------#
 FUNCTION pol0782_elimina_txt_ped_ger()
#----------------------------------#   
...
END FUNCTION   
#-------------------------------#
 FUNCTION pol0782_copia_oc()
#-------------------------------#


      IF pol0782_inclui_oc() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_inclui_prog() = FALSE THEN
         RETURN FALSE
      END IF 
      
      IF pol0782_inclui_prog_com() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_inclui_dest() = FALSE THEN
         RETURN FALSE
      END IF 
  
      IF pol0782_inclui_estr() = FALSE THEN
         RETURN FALSE
      END IF 
   
      IF pol0782_inclui_txt() = FALSE THEN
         RETURN FALSE
      END IF 
      
       IF pol0782_inclui_compl() = FALSE THEN
         RETURN FALSE
      END IF 
      
      IF pol0782_inclui_cotacao() = FALSE THEN
         RETURN FALSE
      END IF 
      IF lr_wpol0782.cod_empresa = l_empresas_885.cod_emp_oficial  THEN
         IF pol0782_inclui_pedido() = FALSE THEN
            RETURN FALSE
         END IF 
         IF pol0782_inclui_pedido_txt() = FALSE THEN
            RETURN FALSE
         END IF 
      END IF 
...
#----------------------------------#
    INITIALIZE t_ordem_sup.* TO NULL 
      ...
      IF pol0782_compara_oc() = FALSE THEN
           RETURN FALSE 
      END IF
...
#----------------------------------#
   ...
   FOREACH cq_in_prog INTO l_prog_ordem_sup.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_prog() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
    INITIALIZE t_prog_ordem_sup.* TO NULL 
      ...
      IF pol0782_compara_prog() = FALSE THEN
         RETURN FALSE 
      END IF
...
END FUNCTION     
#----------------------------------#
 FUNCTION pol0782_inclui_prog_com()
#----------------------------------#
  {Inclui prog_ordem_sup_com se houver}
   ...
   FOREACH cq_in_prog_com INTO l_prog_ordem_sup_com.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_prog_com() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#------------------------------#
    INITIALIZE t_prog_ordem_sup_com.* TO NULL 
      ...
      IF pol0782_compara_prog_com() = FALSE THEN
         RETURN FALSE 
      END IF
...
END FUNCTION   
#----------------------------------#
 FUNCTION pol0782_compara_prog_com()
#----------------------------------#
...
#----------------------------------#
   ...
   FOREACH cq_in_dest INTO l_dest_ordem_sup.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_dest() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
    INITIALIZE t_dest_ordem_sup.* TO NULL 
      ...
      IF pol0782_compara_dest() = FALSE THEN
         RETURN FALSE 
      END IF
...
#----------------------------------#
   ...
   FOREACH cq_in_estr INTO l_estrut_ordem_sup.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_estr() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
    INITIALIZE t_estrut_ordem_sup.* TO NULL 
     ...
     WHERE cod_empresa 		= p_cod_empresa_copia 
      ...
      IF pol0782_compara_estr() = FALSE THEN
         RETURN FALSE 
      END IF
...
#----------------------------------#
    INITIALIZE t_ordem_sup_txt.* TO NULL 
     ...
     WHERE cod_empresa 		= p_cod_empresa_copia 
      ...
      IF pol0782_compara_txt() = FALSE THEN
         RETURN FALSE 
      END IF
...
#----------------------------------#
   ...
   FOREACH cq_in_compl INTO l_ordem_sup_compl.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_compl() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
    INITIALIZE t_ordem_sup_compl.* TO NULL 
     ...
     WHERE cod_empresa 		= p_cod_empresa_copia 
      ...
      IF pol0782_compara_compl() = FALSE THEN
         RETURN FALSE 
      END IF
...
#----------------------------------#   
 FUNCTION pol0782_compara_compl()
#----------------------------------#
...
END FUNCTION 
#----------------------------------#
 FUNCTION pol0782_inclui_cotacao()
#----------------------------------#
   ...
   FOREACH cq_in_cot INTO l_ordem_sup_cot.*
     ...
     WHERE cod_empresa 		 = lr_wpol0782.cod_empresa
      ...
      AND  cod_item        = l_ordem_sup_cot.cod_item    
...
#-------------------------#
    INITIALIZE t_ordem_sup_cot.* TO NULL 
     ...
     WHERE cod_empresa 		= p_cod_empresa_copia 
      ...
      IF pol0782_compara_cot() = FALSE THEN
         RETURN FALSE 
      END IF
...
#----------------------------------# 
 FUNCTION pol0782_inclui_pedido() 
#----------------------------------#
INITIALIZE l_pedido_sup.* TO NULL
 ...
 INITIALIZE p_num_pedido_of TO NULL
   ...
   FOREACH cq_in_ped INTO l_pedido_sup.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_pedido() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
     ...
     WHERE cod_empresa 		= l_empresas_885.cod_emp_oficial
      ...
      IF pol0782_compara_ped() = FALSE THEN
         RETURN FALSE 
      END IF
...
END FUNCTION        
#------------------------------------# 
 FUNCTION pol0782_inclui_pedido_txt() 
#------------------------------------#
INITIALIZE  l_pedido_sup_txt.* TO NULL
   ...
   DECLARE cq_in_ped_txt CURSOR FOR
    ...
    FOREACH cq_in_ped_txt INTO l_pedido_sup_txt.*
      ...
      LET p_erro =  'N'
      IF pol0782_ver_pedido_txt() = FALSE THEN
         IF p_erro =  'S'  THEN	
            RETURN FALSE         
         ELSE   
            CONTINUE FOREACH 
...
#----------------------------------#
 FUNCTION pol0782_ver_pedido_txt()
#----------------------------------#
   ...
   SELECT *
     ...
     WHERE cod_empresa 		= l_empresas_885.cod_emp_oficial
      ...
      IF pol0782_compara_ped_txt() = FALSE THEN
         RETURN FALSE 
      END IF
...
END FUNCTION  
#----------------------------------#   
 FUNCTION pol0782_compara_ped_txt()
#----------------------------------#
...
END FUNCTION       
#---------------------------------------------------------#
 FUNCTION pol0782_deleta_wpol0782()
#---------------------------------------------------------#
  
 
  DELETE FROM wpol0782
   WHERE  num_oc        = lr_wpol0782.num_oc
     AND indicador     = lr_wpol0782.indicador

   IF SQLCA.SQLCODE <> 0 THEN 
      ERROR 'Problemas na deleção wpol0782 - Erro nº ', STATUS
      RETURN FALSE
   ELSE
      RETURN TRUE
   END IF
