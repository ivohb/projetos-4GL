...
#--------------------------#
   ...
   LET p_parametros_885.cod_empresa = p_cod_emp_ger
   ...
   IF pol0779_entrada_dados("INCLUSAO") THEN
      ...
      ELSE
         LET p_parametros_885.cod_empresa = p_cod_emp_ofic
         INSERT INTO parametros_885 
            VALUES (p_parametros_885.*)
         IF SQLCA.SQLCODE <> 0 THEN         
            CALL log003_err_sql("LENDO", "PARAMETROS_885_2")         
            CALL log085_transacao("ROLLBACK")
         ELSE
