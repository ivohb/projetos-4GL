...
create table man_apont_hist_454 
  (
...
revoke all on man_apont_hist_454 from "public" as "admlog";


create index man_apont_hist_454 on man_apont_hist_454 
    (empresa,ordem_producao)  ;
