...
# SISTEMA.: LOGIX                                                   #
# PROGRAMA: pol1064                                                 #
# OBJETIVO: TÍTULOS DE PAGAMENTO DE APARAS - CIBRAPEL               #
# AUTOR...: WILL                                                    #
# DATA....: 06/10/10                                                #
#-------------------------------------------------------------------#
...
#--------------------------#
   ...
   IF NOT pol1064_le_empresa() THEN
      RETURN
   END IF
...
#----------------------------------#
   ...
   IF NOT pol1064_le_orig_destino(p_cod_empresa) THEN
      RETURN FALSE
   END IF
...
#------------------------------#
   ...
   FOREACH cq_padrao INTO
      ...
      IF NOT pol1064_le_orig_destino(p_cod_emp_ger) THEN
         RETURN FALSE
      END IF
...
#----------------------------------------------#
 FUNCTION pol1064_le_orig_destino(m_cod_empresa)
#----------------------------------------------#
   ...
   SELECT cod_empresa_destin                                  
    ...
    WHERE cod_empresa_orig = m_cod_empresa                 
                                                              
   IF STATUS = 100 THEN                                    
      LET p_cod_empresa_destin = m_cod_empresa             
   ELSE                                                    
      IF STATUS <> 0 THEN                                  
   ...
   FORMAT
      ...
      {PAGE HEADER  
         ...
         PRINT COLUMN 001, "pol1064",
               COLUMN 044, "TITULOS PARA PAGAMENTO DE APARAS",
               COLUMN 079, p_tela.dat_inicial, " - ", p_tela.dat_final,
               COLUMN 165, "EMISSAO: ", TODAY USING "dd/mm/yyyy", " - ", TIME
