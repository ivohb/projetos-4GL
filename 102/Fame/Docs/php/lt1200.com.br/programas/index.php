...
$valida_exp="select ctr_exp from sincol_usuarios
...
$emp_padrao=$mat["cod_empresa_padrao"];
   ...
   if($cod==$ifx_user){
	                $query3 ="insert into sincol_logins";
...
include('../bibliotecas/table_80.inc');
...
printf("<br>");
        ...
        /*caso o usuario ou a senha nao estajam cadastrados no logis*/
 	}else{
	                $query3 ="insert into sincol_logins";
                        ...
                        $query3.=$ip_ext."','";
                        $query3.=$ifx_senha."')";
                        $link=@ifx_connect("logix",web_sincol,valida);
