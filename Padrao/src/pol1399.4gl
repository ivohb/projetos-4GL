...
#---------------------------------#
    ...
    CALL _ADVPL_set_property(l_label,"TEXT","Cobrar titulo em execução judicial:")    
    CALL _ADVPL_set_property(l_label,"FONT",NULL,NULL,TRUE,FALSE)
    ...
    CALL _ADVPL_set_property(l_label,"TEXT","Texto do cabeçalho:")    
    CALL _ADVPL_set_property(l_label,"FONT",NULL,NULL,TRUE,FALSE)
    ...
    CALL _ADVPL_set_property(l_label,"TEXT","Texto do rodapé:")    
    CALL _ADVPL_set_property(l_label,"FONT",NULL,NULL,TRUE,FALSE)
...
#--------------------------------#
   ...
   IF mr_cobranca.cod_cliente IS NULL THEN
      LET m_msg = 'Informe o cliente para cobrança.'
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      RETURN FALSE
   END IF
...
#--------------------------------#
    ...
    CALL _ADVPL_set_property(l_label,"POSITION",300,10)  
    CALL _ADVPL_set_property(l_label,"TRANSPARENT",TRUE)    
    CALL _ADVPL_set_property(l_label,"TEXT","CADASTRO DE PORTADORES ISENTOS DE COBRANÇA")    
    CALL _ADVPL_set_property(l_label,"FONT",NULL,11,TRUE,TRUE)  
...
#-----------------------------#
   ...
   IF m_exc_portador THEN 
      LET m_msg = 'Não dados na tela a serem excluidos'
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)   
      RETURN FALSE
   END IF
...
#-----------------------------#
   ...
   IF NOT LOG_question("Confirma a exclusão dos dados?") THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",
             "Operação cancelada.")
      RETURN FALSE
   END IF
