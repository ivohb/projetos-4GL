...
#           PROGRAMA ESPECIFICO DA POLIMETRI                        #
# CLIENTE.: POLIMETRI                                               #
# DATA....: 12/04/2001                                              #
#-------------------------------------------------------------------#
DATABASE logix
...
GLOBALS
  ...
  DEFINE p_comando              CHAR(080),
         ...
         p_cod_ferramenta           LIKE consumo_fer.cod_ferramenta,
       	 ...
       	 p_num_seq_linha            LIKE consumo_txt.num_seq_linha,    
       	 p_cont                     SMALLINT,
...
MAIN
LET p_versao = "POL0138-10.02.00" #Favor nao alterar esta linha (SUPORTE)
...
#--------------------------#
  ...
  CALL log130_procura_caminho("pol0138") RETURNING p_nom_tela
  LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol0138 AT 2,2 WITH FORM p_nom_tela
...
#----------------------------------#
 ...
 DECLARE ct_cons  CURSOR FOR
   SELECT a.cod_operac, a.parametro,a.cod_arranjo,  b.den_operac 
     FROM consumo a, operacao b
    WHERE a.cod_empresa=p_cod_empresa          AND 
          a.cod_item   =p_ordens.cod_item      AND
          a.cod_roteiro=p_ordens.cod_roteiro   AND
          a.cod_empresa=b.cod_empresa          AND
          a.cod_operac=b.cod_operac

   IF sqlca.sqlcode <> 0 THEN
      CALL log003_err_sql("CURSOR","CONSUMO")
   END IF

   FOREACH ct_cons INTO p_cod_operac, p_parametro,p_cod_arranjo, p_den_operac 
...
WHENEVER ERROR CONTINUE
 ...
 DECLARE ct_fer   CURSOR FOR
   SELECT a.cod_ferramenta, b.des_compon_reduz
     FROM consumo_fer a, componente b
    WHERE a.cod_empresa     = p_cod_empresa
      AND a.cod_empresa     = b.cod_empresa 
      AND a.cod_ferramenta  = b.cod_compon 
...
WHENEVER ERROR STOP
   ...
   SELECT tex_processo , num_seq_linha          
     FROM consumo_txt               
    WHERE cod_empresa  = p_cod_empresa
