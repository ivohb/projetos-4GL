   ...
   FOREACH cq_importa INTO p_aponta.*
      ...
      SELECT COUNT(*)
       ...
       WHERE    dat_producao    =  p_aponta.dat_producao 
         ...
         #AND    cod_maquina     =  p_aponta.cod_maquina #ivo - 20/09/2011 - máquina não é mais enviada
         AND    qtd_refugo      =  p_aponta.qtd_refugo 
         AND    qtd_boas        =  p_aponta.qtd_boas 
         AND    tip_mov         =  p_aponta.tip_mov
         #AND    mat_operador    =  p_aponta.mat_operador #Manuel - 28/09/2011 - O Ega não manda mais o operador que é substituido por um padrão por turno
