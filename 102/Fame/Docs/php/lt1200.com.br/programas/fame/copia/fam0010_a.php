...
//CARTEIRA
  ...
  $pdf->SetFillColor(260);
  $selec_pedido="
          SELECT (b.num_nff||'-'||b.cod_empresa) as ped_emp,
                  b.num_nff as num_pedido,b.cod_empresa,
                  0 as pct_desc_financ,
                  0 as pct_desc_adic_ped,
                  b.pct_frete,b.ies_situacao as ies_sit_pedido,
                  (e.val_liq_item/e.qtd_item) as pre_unit,
                  e.qtd_item as qtd_pecas_solic,0 as qtd_pecas_atend,0 as qtd_pecas_cancel,
                  e.pct_desc_adic,0 as pct_desc_bruto,e.num_sequencia,
		  year(b.dat_emissao) as ano ,month(b.dat_emissao) as mes,
		  (month(b.dat_emissao)||'/'||year(b.dat_emissao) ) as mesano,
		  i.nom_cliente,i.cod_cliente,
                  day(b.dat_emissao) as dia,
                  l.den_grupo_item ,
		  year(b.dat_emissao) as ano_ped ,month(b.dat_emissao) as mes_ped,
