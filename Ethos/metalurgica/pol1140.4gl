...
# Recriar tabela man_apo_logix_405                                  #
# alter table man_apo_nest_405 id_registro serial                   #
#-------------------------------------------------------------------#
...
#--------------------------#
   ...
   MENU "OPCAO"
      ...
      COMMAND "Processar" "Processa apontamentos pendentes/criticados"
         ...
         CALL pol1186_proces_apto(p_user, p_cod_empresa, 'pol1140') RETURNING p_qtd_critica
...
#------------------------------#
FUNCTION pol1140_empty(p_campo)
#------------------------------#
...
#-----------------------------#
   ...
   if pol1140_empty(p_programa.num_ordem) then
...
#--------------------------------#
   ...
   if pol1140_empty(p_programa.cod_operac) then
...
#----------------------------------#
   ...
   if pol1140_empty(p_programa.cod_item_compon) then
...
#---------------------------------#
   ...
   if pol1140_empty(p_programa.tempo_unit) OR p_programa.tempo_unit = 0 then
