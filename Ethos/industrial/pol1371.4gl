...
# SISTEMA.: LOGIX                                                   #
# PROGRAMA: pol1371                                                 #
# OBJETIVO: CADASTRO DE ITEN CLIENTE/PEDIDO DE COMPRA X ITEM LOGIX  #
# AUTOR...: IVO                                                     #
#-------------------------------------------------------------------#
...
DEFINE mr_cabec          RECORD
       ...
       num_ped_cli       LIKE pedidos.num_pedido_cli
END RECORD
...
#----------------------#
    ...
    CALL _ADVPL_set_property(l_create,"EVENT","pol1371_create")
    CALL _ADVPL_set_property(l_create,"CONFIRM_EVENT","pol1371_create_confirm")
    CALL _ADVPL_set_property(l_create,"CANCEL_EVENT","pol1371_create_cancel")
    
    LET l_update = _ADVPL_create_component(NULL,"LUPDATEBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_update,"EVENT","pol1371_update")
    CALL _ADVPL_set_property(l_update,"CONFIRM_EVENT","pol1371_update_confirm")
    CALL _ADVPL_set_property(l_update,"CANCEL_EVENT","pol1371_update_cancel")

    LET l_find = _ADVPL_create_component(NULL,"LFINDBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_find,"TYPE","NO_CONFIRM")
    CALL _ADVPL_set_property(l_find,"EVENT","pol1371_find")

    LET l_first = _ADVPL_create_component(NULL,"LFIRSTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_first,"EVENT","pol1371_first")

    LET l_previous = _ADVPL_create_component(NULL,"LPREVIOUSBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_previous,"EVENT","pol1371_previous")

    LET l_next = _ADVPL_create_component(NULL,"LNEXTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_next,"EVENT","pol1371_next")

    LET l_last = _ADVPL_create_component(NULL,"LLASTBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_last,"EVENT","pol1371_last")

    LET l_delete = _ADVPL_create_component(NULL,"LDELETEBUTTON",l_menubar)
    CALL _ADVPL_set_property(l_delete,"EVENT","pol1371_delete")
    ...
    CALL _ADVPL_set_property(l_importar,"EVENT","pol1371_importar")
    CALL _ADVPL_set_property(l_importar,"CONFIRM_EVENT","pol1371_imp_conf")
    CALL _ADVPL_set_property(l_importar,"CANCEL_EVENT","pol1371_imp_cancel")
    ...
    CALL pol1371_cabec(l_panel)
    CALL pol1371_itens(l_panel)

    CALL pol1371_ativa_desativa(FALSE)
...
#----------------------------------#
FUNCTION pol1371_cabec(l_container)#
#----------------------------------#
    ...
    CALL _ADVPL_set_property(m_sel_arquivo,"CHANGE_EVENT","pol1371_imp_arquivo") 
    ...
    CALL _ADVPL_set_property(m_cliente,"VALID","pol1371_chec_cliente")
    ...
    CALL _ADVPL_set_property(m_lupa_cliente,"CLICK_EVENT","pol1371_cliente_zoom")
    ...
    CALL _ADVPL_set_property(m_cli_item,"VALID","pol1371_chec_it_cliente")
    ...
    CALL _ADVPL_set_property(l_label,"TEXT","Ped compra:")    

    LET m_ped_cli = _ADVPL_create_component(NULL,"LTEXTFIELD",m_panel)
    CALL _ADVPL_set_property(m_ped_cli,"POSITION",120,40)     
    CALL _ADVPL_set_property(m_ped_cli,"LENGTH",15) 
    CALL _ADVPL_set_property(m_ped_cli,"VARIABLE",mr_cabec,"num_ped_cli")
    CALL _ADVPL_set_property(m_ped_cli,"VALID","pol1371_chec_ped_compra")
    ...
    CALL _ADVPL_set_property(m_item,"POSITION",365,40)     
    ...
    CALL _ADVPL_set_property(m_item,"VALID","pol1371_chec_item")

    LET m_lupa_cliente = _ADVPL_create_component(NULL,"LIMAGEBUTTON",m_panel)
    CALL _ADVPL_set_property(m_lupa_cliente,"POSITION",500,40)     
    CALL _ADVPL_set_property(m_lupa_cliente,"IMAGE","BTPESQ")
    CALL _ADVPL_set_property(m_lupa_cliente,"SIZE",24,20)
    CALL _ADVPL_set_property(m_lupa_cliente,"CLICK_EVENT","pol1371_item_zoom")

    LET l_descricao = _ADVPL_create_component(NULL,"LTEXTFIELD",m_panel)
    CALL _ADVPL_set_property(l_descricao,"POSITION",535,40)     
    CALL _ADVPL_set_property(l_descricao,"LENGTH",50) 
    CALL _ADVPL_set_property(l_descricao,"EDITABLE",FALSE) 
    ...
    CALL _ADVPL_set_property(m_pedido,"POSITION",1090,40)     
    CALL _ADVPL_set_property(m_pedido,"LENGTH",7)
    CALL _ADVPL_set_property(m_pedido,"VARIABLE",mr_cabec,"num_pedido")
    CALL _ADVPL_set_property(m_pedido,"VALID","pol1371_chec_pedido")

    LET m_lupa_pedido = _ADVPL_create_component(NULL,"LIMAGEBUTTON",m_panel)
    CALL _ADVPL_set_property(m_lupa_pedido,"POSITION",1160,40)     
    CALL _ADVPL_set_property(m_lupa_pedido,"IMAGE","BTPESQ")
    CALL _ADVPL_set_property(m_lupa_pedido,"SIZE",24,20)
    CALL _ADVPL_set_property(m_lupa_pedido,"CLICK_EVENT","pol1371_pedido_zoom")

END FUNCTION

FUNCTION pol1371_on_change()

   CALL log0030_mensagem('pol1371_on_change','info')
   RETURN TRUE

END FUNCTION
   
#----------------------------------#
FUNCTION pol1371_itens(l_container)#
#----------------------------------#
    ...
    LET l_tabcolumn = _ADVPL_create_component(NULL,"LTABLECOLUMNEX",m_brz_itens)
    CALL _ADVPL_set_property(l_tabcolumn,"HEADER","Pedido ciente")
...
#----------------------------------------#
FUNCTION pol1371_ativa_desativa(l_status)#
#----------------------------------------#
   ...
   IF m_opcao = 'M' THEN
      ...
      CALL _ADVPL_set_property(m_ped_cli,"EDITABLE",FALSE)
   ELSE
      ...
      CALL _ADVPL_set_property(m_ped_cli,"EDITABLE",l_status)
   END IF
...
#-----------------------#
FUNCTION pol1371_create()
#-----------------------#
    
    LET m_opcao = 'I'    
    CALL pol1371_limpa_campos()
    CALL pol1371_ativa_desativa(TRUE)
...
#-------------------------------#
FUNCTION pol1371_create_confirm()
#-------------------------------#
   
   IF NOT pol1371_chec_cliente() THEN
      RETURN FALSE
   END IF

   IF NOT pol1371_chec_ped_compra() THEN
      RETURN FALSE
   END IF

   IF NOT pol1371_chec_it_cliente() THEN
      RETURN FALSE
   END IF

   IF NOT pol1371_chec_item() THEN
      RETURN FALSE
   END IF

   IF NOT pol1371_chec_pedido() THEN
      RETURN FALSE
   END IF

   LET m_msg = NULL

   IF NOT pol1371_chec_chave_dipl() OR m_msg IS NOT NULL THEN
...
#-------------------------------#
FUNCTION pol1371_create_cancel()#
#-------------------------------#
...
#------------------------------#
   ...
   IF NOT pol1371_le_cliente() OR m_msg IS NOT NULL THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      RETURN FALSE
   END IF 
...
#---------------------------------#
FUNCTION pol1371_chec_it_cliente()#
#---------------------------------#
   ...
   IF NOT pol1371_le_cli_item() OR m_msg IS NOT NULL THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      CALL _ADVPL_set_property(m_cli_item,"GET_FOCUS")
      RETURN FALSE
   END IF 
...
#---------------------------------#
FUNCTION pol1371_chec_ped_compra()#
#---------------------------------#

   LET m_msg = NULL
   CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)

   IF mr_cabec.num_ped_cli IS NULL THEN
      LET m_msg = 'Informe pedido do cliente.'
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      CALL _ADVPL_set_property(m_ped_cli,"GET_FOCUS")
      RETURN FALSE
   END IF
...
#---------------------------#
   ...
   IF NOT pol1371_le_item() OR m_msg IS NOT NULL THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      CALL _ADVPL_set_property(m_item,"GET_FOCUS")
      RETURN FALSE
   END IF 
...
#-----------------------------#
   ...
   IF NOT pol1371_le_pedido() OR m_msg IS NOT NULL THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
      RETURN FALSE
   END IF 
...
#-----------------------------#
   ...
   IF NOT p_status THEN
      LET mr_cabec.den_it_cli = 'Item não cadastrdo no MAN10021/Comercial3.'
      #RETURN FALSE
   END IF
...
#---------------------------#
FUNCTION pol1371_le_pedido()#
#---------------------------#
   
   DEFINE l_sql          VARCHAR(800),
          l_num_pedido   INTEGER
   
   LET l_sql = " SELECT num_pedido_cli  FROM pedidos ",
    " WHERE cod_empresa = '",p_cod_empresa,"' ",
      " AND num_pedido = '",mr_cabec.num_pedido,"' ",
      " AND cod_cliente = '",mr_cabec.cod_cliente,"' ",
      " AND ies_sit_pedido <> '9' ",
      " AND num_pedido_cli = '",mr_cabec.num_ped_cli,"' "
      
      #" AND num_pedido_cli LIKE '","%",mr_cabec.num_ped_cli CLIPPED,"%","' "

    PREPARE var_sql FROM l_sql
    
    IF STATUS <> 0 THEN
       CALL log003_err_sql("PREPARE SQL","pedidos:PREPARE SQL")
       RETURN FALSE
    END IF

    DECLARE cq_sql SCROLL CURSOR WITH HOLD FOR var_sql

    IF  STATUS <> 0 THEN
        CALL log003_err_sql("DECLARE CURSOR","DECLARE:cq_sql")
        RETURN FALSE
    END IF
    ...
    IF STATUS <> 0 THEN
       CALL log003_err_sql("OPEN CURSOR","OPEN:cq_sql")
       RETURN FALSE
    END IF

    FETCH cq_sql INTO l_num_pedido

    IF STATUS <> 0 THEN
       IF sqlca.sqlcode = NOTFOUND THEN
          LET m_msg = 'Pedido não existe, não é do cliente em questão.'
       ELSE
          CALL log003_err_sql("FETCH CURSOR","FETCH:cq_sql")          
       END IF
   ELSE
      RETURN TRUE
   END IF
...
#---------------------------------#
FUNCTION pol1371_chec_chave_dipl()#
#---------------------------------#
   ...
   SELECT id_registro
    ...
    WHERE cod_empresa = p_cod_empresa
      ...
      AND num_ped_cli = mr_cabec.num_ped_cli

   IF STATUS = 0 THEN
      LET m_msg = 'Cliente/item/ped compra já cadastrado no pol1371'
   ELSE
      IF STATUS <> 100 THEN
         CALL log003_err_sql('INSERT','cliente_item_pc_547')
         RETURN FALSE
      END IF
   END IF
...
#-------------------------#
FUNCTION pol1371_inserir()#
#-------------------------#

   INSERT INTO cliente_item_pc_547(
      cod_empresa, 
      cod_cliente, 
      cod_it_cli,  
      num_ped_cli,
...
#----------------------#
    ...
    IF m_construct IS NULL THEN
       ...
       CALL _ADVPL_set_property(m_construct,"CONSTRUCT_NAME","pol1371_FILTER")
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_TABLE","cliente_item_pc_547","cliente")
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_COLUMN","cliente_item_pc_547","cod_cliente","Cliente",1 {CHAR},15,0,"zoom_cliente")
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_COLUMN","cliente_item_pc_547","cod_it_cli","Item cliente",1 {CHAR},30,0)
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_COLUMN","cliente_item_pc_547","num_ped_cli","Pedido cliente",1 {CHAR},30,0)
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_COLUMN","cliente_item_pc_547","cod_item","Item",1 {CHAR},15,0,"zoom_item")
       CALL _ADVPL_set_property(m_construct,"ADD_VIRTUAL_COLUMN","cliente_item_pc_547","num_pedido","Pedido",1 {INT},9,0)
    END IF
    ...
    IF l_status THEN
       ...
       CALL pol1371_create_cursor(l_where,l_order)
    ELSE
...
#-----------------------------------------------#
FUNCTION pol1371_create_cursor(l_where, l_order)#
#-----------------------------------------------#
    ...
    IF STATUS <> 0 THEN
       CALL log003_err_sql("PREPARE SQL","cliente_item_pc_547")
       RETURN FALSE
    END IF
...
#-----------------------------#
   ...
   IF STATUS <> 0 THEN
      CALL log003_err_sql('SELECT','cliente_item_pc_547:ed')
      RETURN
   END IF
   
   IF NOT pol1371_le_cliente() THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
   END IF

   CALL pol1371_den_cli_item() 
   
   IF NOT pol1371_le_item() THEN
      CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",m_msg)
   END IF
...
#----------------------------------#
FUNCTION pol1371_paginacao(l_opcao)#
#----------------------------------#
   
   DEFINE l_opcao CHAR(01),
          l_achou SMALLINT

   IF NOT pol1371_ies_cons() THEN
      RETURN FALSE
   END IF
...
#-----------------------#
FUNCTION pol1371_first()#
#-----------------------#

   IF NOT pol1371_paginacao('F') THEN
      RETURN FALSE
   END IF
...
#----------------------#
FUNCTION pol1371_next()#
#----------------------#

   IF NOT pol1371_paginacao('N') THEN
      RETURN FALSE
   END IF
...
#--------------------------#
FUNCTION pol1371_previous()#
#--------------------------#

   IF NOT pol1371_paginacao('P') THEN
      RETURN FALSE
   END IF
...
#----------------------#
FUNCTION pol1371_last()#
#----------------------#

   IF NOT pol1371_paginacao('L') THEN
      RETURN FALSE
   END IF
...
#----------------------------------#
 FUNCTION pol1371_prende_registro()#
#----------------------------------#
...
#------------------------#
   ...
   IF NOT pol1371_prende_registro() THEN
      RETURN FALSE
   END IF
...
#--------------------------------#
FUNCTION pol1371_update_confirm()#
#--------------------------------#
   
   DEFINE l_ret   SMALLINT
   
   UPDATE cliente_item_pc_547
   ...
   IF STATUS <> 0 THEN
      CALL log003_err_sql('UPDATE','cliente_item_pc_547')
      LET l_ret = FALSE
   ELSE
      LET l_ret = TRUE
   END IF
...
#------------------------------#
FUNCTION pol1371_update_cancel()
#------------------------------#
...
#------------------------#
   ...
   DELETE FROM cliente_item_pc_547
    WHERE cod_empresa = p_cod_empresa
      AND id_registro = m_id_registro

   IF STATUS <> 0 THEN
      CALL log003_err_sql('DELETE','cliente_item_pc_547')
      LET l_ret = FALSE
   ELSE
      LET l_ret = TRUE
   END IF
...
#--------------------------#
   ...
   IF NOT pol1371_carrega_arqs() THEN
      RETURN FALSE
   END IF
...
#------------------------------#
FUNCTION pol1371_carrega_arqs()#
#------------------------------#

   DEFINE l_ind     INTEGER,
          t_ind     CHAR(03)

   IF NOT pol1371_le_caminho() THEN
      RETURN FALSE
   END IF
...
#-----------------------------#
   ...
   LET p_status = LOG_progresspopup_start(
       "Processando...","pol1371_sepa_info","PROCESS")  
...
#---------------------------#
   ...
   FOREACH cq_linha INTO m_registro
      ...
      LET m_pos_ini = 1
      LET ma_itens[m_ind].cod_cliente = pol1371_divide_texto()
      LET ma_itens[m_ind].num_pedido = pol1371_divide_texto()
      LET ma_itens[m_ind].cod_item = pol1371_divide_texto()
      LET ma_itens[m_ind].item_cliente = pol1371_divide_texto()
      LET ma_itens[m_ind].num_ped_cli = pol1371_divide_texto()
      ...
      IF ma_itens[m_ind].num_ped_cli IS NULL THEN
         LET m_msg = m_msg CLIPPED, ' - Pedido do cliente inválido;'
      END IF
      
      IF m_msg IS NULL THEN
         IF NOT pol1371_consiste() THEN
            RETURN FALSE
         END IF
      END IF
      ...
      ELSE
         SELECT id_registro
          ...
          WHERE cod_empresa = p_cod_empresa
            ...
            AND num_ped_cli = ma_itens[m_ind].num_ped_cli

         IF STATUS = 0 THEN
            LET m_msg = 'Cliente/item já cadastrado no pol1371'
         ELSE
            IF STATUS <> 100 THEN
               CALL log003_err_sql('INSERT','cliente_item_pc_547')
               RETURN FALSE
...
#--------------------------#
   ...
   IF NOT pol1371_proc_import() THEN
      CALL LOG_transaction_rollback()
      RETURN FALSE
   END IF
   ...
   LET p_status = pol1371_imp_cancel()
   LET m_ies_cons = FALSE
...
#-----------------------------#
   ...
   FOR m_ind = 1 TO l_qtd_reg
       ...
       IF ma_itens[m_ind].mensagem IS NULL THEN
          IF NOT pol1371_ins_import() THEN
             RETURN FALSE
          END IF          
       END IF
   ...
   IF NOT pol1371_move_arquivo() THEN
      RETURN FALSE
   END IF
...
#----------------------------#
   ...
   IF STATUS <> 0 THEN
      CALL log003_err_sql('INSERT','cliente_item_pc_547:import')
      RETURN FALSE
   END IF
