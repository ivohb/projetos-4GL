...
#-------------------------------#
 ...
 RETURN "$Archive: /Logix/Fontes_Doc/Customizacao/10R2/gps_logist_e_gerenc_de_riscos_ltda/financeiro/controle_despesa_viagem/programas/pol1396.4gl $|$Revision: 10 $|$Date: 28/10/2020 13:28 $|$Modtime: 15/10/2020 14:12 $" #Informações do controle de versão do SourceSafe - Não remover esta linha (FRAMEWORK)
