...
DEFINE ma_produto      ARRAY[1000] OF RECORD
       cod_item        CHAR(15),
       den_item        CHAR(50)
END RECORD
...
#----------------------#
    ...
    LET l_titulo = "ANÁLISE DE CUSTOS DO COMPONENTE DO ITEM"
...
#---------------------------------------#
    ...
    CALL _ADVPL_set_property(l_label,"POSITION",260,20)     
