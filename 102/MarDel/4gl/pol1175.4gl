...
# DATA....: 16/11/2012 conversção para 10.02 (Ivo)                  #
#-------------------------------------------------------------------#
DATABASE logix 
...
GLOBALS
   DEFINE p_cod_empresa        LIKE empresa.cod_empresa,
          ...
          p_msg                CHAR(500),  
          p_cod_simbolo        char(02),
          p_den_simbolo        char(30)
          

   DEFINE p_simbolo_5054 RECORD 
    cod_empresa  char(2),
    cod_simbolo  char(2),
    den_simbolo  char(30),
    cod_tip_oper decimal(1,0)
   END RECORD
...
MAIN
   ...
   DEFER INTERRUPT
   LET p_versao = "pol1175-10.02.00"
   INITIALIZE p_nom_help TO NULL  
   CALL log140_procura_caminho("pol1175.iem") RETURNING p_nom_help
   ...
   IF p_status = 0  THEN
      CALL pol1175_controle()
   END IF
END MAIN

#--------------------------#
 FUNCTION pol1175_controle()
#--------------------------#

   CALL log006_exibe_teclas("01",p_versao)
   INITIALIZE p_nom_tela TO NULL 
   CALL log130_procura_caminho("pol1175") RETURNING p_nom_tela
   LET p_nom_tela = p_nom_tela CLIPPED 
   OPEN WINDOW w_pol1175 AT 2,2 WITH FORM p_nom_tela
   ...
   MENU "OPCAO"
      COMMAND "Incluir" "Inclui Dados na Tabela"
         ...
         CALL pol1175_modificar() RETURNING p_status
         IF p_status THEN
      ...
      COMMAND "Fim"       "Retorna ao Menu Anterior"
         ...
         EXIT MENU
   END MENU
   CLOSE WINDOW w_pol1175

END FUNCTION

#--------------------------#
FUNCTION pol1175_modificar()
#--------------------------#

   IF pol1175_aceita_simbolos() THEN
      CALL pol1175_grava_simbolos()
   ELSE
      CALL pol1175_exibe_simbolos()
   END IF
...
#--------------------------------#
FUNCTION pol1175_aceita_simbolos()
#--------------------------------#
...
#--------------------------------#
FUNCTION pol1175_grava_simbolos()
#--------------------------------#
   ...
   ELSE
      ...
      CALL log003_err_sql("GRAVAÇÃO","simbolo_5054")
      LET p_retorno = FALSE
   END IF      
   WHENEVER ERROR STOP
...
#--------------------------------#
 FUNCTION pol1175_exibe_simbolos()
#--------------------------------#
   ...
   IF p_index = 1 THEN
      LET p_msg = 'Não há dados a serem exibidos!'
      error p_msg
      LET p_ies_cons = FALSE
      RETURN
   END IF
...
#-----------------------------------#
 FUNCTION pol1175_emite_relatorio()
#-----------------------------------#
   ...
   FOREACH cq_imp INTO p_simbolo_5054.*
   

      OUTPUT TO REPORT pol1175_relat() 
