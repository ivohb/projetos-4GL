...
GLOBALS
   ...
   DEFINE p_numromaneio       LIKE roma_item_885.numromaneio,
          ...
          p_numsequencia_ant  LIKE roma_item_885.numsequencia,
...
#---------------------#
   ...
   FORMAT
      ...
      PAGE HEADER  
         ...
         PRINT COLUMN 001, "------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
         PRINT
         PRINT COLUMN 001, ' Romaneio  Cid.   Nome da cidade sqi Identifi.   Operação  Seq. roma. Pedido    Cod. item          Lote      Peso liquido  Peso bruto   Volumes   Qdt. peças Tolerancia Qtd. pac.  S'
         PRINT COLUMN 001, '---------- -----  -------------- --- ---------- ---------- ---------- ------ --------------- --------------- ------------ ------------ ---------- ---------- ---------- ---------- -'
