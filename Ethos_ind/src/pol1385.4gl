...
DEFINE ma_deman          ARRAY[1000] OF RECORD
       cod_cliente       CHAR(15),
...
#--------------------------------#
   ...
   LOAD FROM m_arq_arigem INSERT INTO w_demanda
...
#---------------------------#
   ...
   CALL _ADVPL_set_property(m_statusbar,"ERROR_TEXT",'Em construção')
   RETURN TRUE
...
#-------------------------------#
   ...
   LOAD FROM m_arq_arigem INSERT INTO w_item
...
#--------------------------#
   ...
   INSERT INTO pl_it_me_grade(
      ...
      qtd_plano) VALUES (
         ...
         ma_deman[m_ind].ano_ref,    
         ma_deman[m_ind].qtd_plano)
