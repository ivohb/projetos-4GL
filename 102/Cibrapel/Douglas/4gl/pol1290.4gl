...
GLOBALS
    DEFINE p_cod_empresa        LIKE empresa.cod_empresa,
           ...
           p_ini_periodo        LIKE periodo_apuracao_885.ini_periodo,
           p_fim_periodo        LIKE periodo_apuracao_885.fim_periodo
...
#--------------------------#
    ...
    LET p_opcao = 'I'
    LET p_ini_periodo = EXTEND(CURRENT, YEAR TO DAY)
    LET p_fim_periodo = EXTEND(CURRENT, YEAR TO DAY)
