...
union
             select 'Notas de Consertos' as tp_nf,a.ies_especie_nf,a.cod_empresa,a.num_nf,a.ser_nf,
                ...
                where a.cod_empresa='".$empresa."'
                   ...
                   $tipo_cons
union
           select 'Notas de Devoluções' as tp_nf,a.ies_especie_nf,a.cod_empresa,a.num_nf,a.ser_nf,
                    a.cod_fornecedor,a.val_tot_nf_d,
                    a.val_tot_icms_nf_d,a.val_ipi_nf,a.val_despesa_aces,
                    a.cod_operacao,
                    b.raz_social,
...
union
           select 'TRANSFERÊNCIAS' as tp_nf,a.ies_especie_nf,a.cod_empresa,a.num_nf,a.ser_nf,
                    a.cod_fornecedor,a.val_tot_nf_d,
                    a.val_tot_icms_nf_d,a.val_ipi_nf,a.val_despesa_aces,
                    a.cod_operacao,
                    b.raz_social,
 ...
 $mat=$cfetch_row($result);
 $titulo="Notas Fiscais de Entrada no período de :".$dini." a ".$dfin;
