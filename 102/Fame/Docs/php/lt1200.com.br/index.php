...
<td width=375 rowspan='5'><img src='../imagens/fame_small.png'></td>
...
printf("<BODY BGCOLOR='WHITE' onload='document.login.ifx_user.focus()'>");
printf("<FORM name='login' onSubmit='return validForm(this)'
