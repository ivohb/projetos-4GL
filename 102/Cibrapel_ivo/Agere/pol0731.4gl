...
# SISTEMA.: VENDAS                                                  #
# PROGRAMA: pol0731                                                 #
# MODULOS.: pol0731-LOG0010-LOG0030-LOG0040-LOG0050-LOG0060         #
...
#--------------------------#
   ...
   IF NOT pol0731_le_empresa() THEN
      RETURN
   END IF

   DISPLAY p_cod_emp_ger TO cod_empresa
  ...
  INPUT BY NAME p_ft_item_885.* 
      ...
      AFTER FIELD cod_cliente
        IF p_ft_item_885.cod_cliente IS NULL THEN 
         ...
         DISPLAY p_ft_item_885.cod_cliente TO cod_cliente         
          NEXT FIELD cod_item
       END IF
      ...
      ELSE  
        ...
        SELECT cod_item,cod_cliente
        FROM ft_item_885
        WHERE cod_item = p_ft_item_885.cod_item 
         AND cod_cliente   = p_ft_item_885.cod_cliente 
         
      IF STATUS = 0 THEN
         ERROR "Código do ITEM/CLIENTE já Cadastrada na Tabela ft_item_885 !!!"
         NEXT FIELD cod_cliente
      END IF         
        INSERT INTO ft_item_885 (nom_item,nom_reduzido) VALUES (p_nom_item,p_nom_reduzido)       
         DISPLAY p_ft_item_885.cod_item TO cod_item         
...
#--------------------------#
   ...
   CONSTRUCT BY NAME where_clause ON ft_item_885.cod_item 
...
#-----------------------------#
   ...
   IF pol0731_cursor_for_update() THEN
      ...
      IF pol0731_entrada_dados("MODIFICACAO") THEN
         UPDATE ft_item_885
            SET cod_item = p_ft_item_885.cod_item
         WHERE cod_empresa = p_ft_item_885.cod_empresa
         AND cod_item = p_ft_item_885.cod_item
