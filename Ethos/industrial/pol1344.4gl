...
#----------------------#
    ...
    LET l_titulo = "APURAÇÃO DA NECESSIDADE DE COMPRAS - ",p_versao
...
#----------------------------------------#
    ...
    CALL _ADVPL_set_property(m_dat_de,"POSITION",110,10)     
